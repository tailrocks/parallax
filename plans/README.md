...
| [167](167-agent-browser-ui-verification.md) | Verify every Parallax UI surface with agent-browser — functional + responsive | BLOCKED — SigNoz Foundry-only residue. 21-route + teaching walk recorded 2026-08-14 (`agent-browser.log`, coverage-matrix). Remaining W5 display FAILs: MCP `check` CLI≢GraphQL JSON; clock-skew banner same-service; exemplar workbench `hasTraceLink=false` |
