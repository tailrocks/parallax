...
Plans 162–164 and 166 are DONE (2026-07-17). 164: faceted filters + where
editor ([evidence](../docs/research/validation/2026-07-wave2/164/README.md)).
166: ELK + React Flow service map, focus/declutter, external nodes
