...
| [163](163-playground-example-upgrades.md) | Upgrade every playground example to current-latest instrumentation and re-verify emission | BLOCKED — SigNoz Foundry residue only for the 5th-sink re-verify. Lockstep landed on playground PR #13 (Rust 1.97.1 / agent 2.30.0 / Sentry 0.49+8.53 / JS 2.10+0.221; sentry-opentelemetry adopted). README matrix re-date + 4-sink dual-emission still required (recheck 2026-08-14T12:41Z) |
...
| [165](165-user-lens-comparison.md) | Run the full playground sweep and record a user-lens comparison across all backends | BLOCKED — SigNoz arm. Maple/OpenObserve/Sentry dispositions still required after 163 dual-emission (recheck 2026-08-14T12:41Z) |
...
| [167](167-agent-browser-ui-verification.md) | Verify every Parallax UI surface with agent-browser — functional + responsive | BLOCKED — playground-seeded 21-route matrix still open. c11 scoped / snapshot PASS on host 2026-08-14 (recheck 2026-08-14T12:41Z) |
