...
pub use datasets::{
    ...
    DASHBOARD_PILOT_NAME, DASHBOARD_PILOT_WIDGET, DatasetId, INVESTIGATION_PILOT_ID,
    INVESTIGATION_PILOT_NAME, LOGS_PILOT_BODY, LOGS_PILOT_COUNT, LOGS_PILOT_SERVICE_A,
    LOGS_PILOT_SERVICE_B, METRICS_PILOT_GAUGE, METRICS_PILOT_HISTOGRAM, ScenarioManifest,
    TRACES_PILOT_CHILD_NAME, TRACES_PILOT_ERROR_NAME, TRACES_PILOT_ROOT_NAME,
    TRACES_PILOT_TRACE_ID, catalog, dataset_ids, manifest_for, pilot_investigation_state_json,
};
pub use real_stack::{
