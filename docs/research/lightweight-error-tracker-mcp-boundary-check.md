...
| --- | --- | --- |
| Bugsink | No MCP or AI agent surface found in the checked README, self-hosting page, or Sentry-SDK compatibility page. Current release: `2.2.1` on 2026-05-22. License file uses PolyForm Shield for most repository content, with noted third-party exceptions. | Strong low-ops Sentry-compatible baseline, but not an agent-access closure in checked sources. |
...
| --- | --- | --- |
| [Bugsink release](https://github.com/bugsink/bugsink/releases/tag/2.2.1), [self-hosting page](https://www.bugsink.com/built-to-self-host/), [Sentry-SDK compatibility page](https://www.bugsink.com/sentry-sdk-compatible/), and [license](https://github.com/bugsink/bugsink/blob/main/LICENSE) | Single-container/SQLite/no-queue posture, Sentry SDK compatibility, no checked MCP/AI agent surface, PolyForm Shield license posture. | Release `2.2.1` published 2026-05-22; repo pushed 2026-05-22. |
...
Lightweight competitors have crossed the "has MCP" threshold. They have not
