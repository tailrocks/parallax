...
| Grouping opacity (Sentry over/under-grouping, fingerprint fights) | `issue.groupingExplanation` + [grouping.md](../../guide/grouping.md); steerability is the gated [fingerprint-rules](../decisions/fingerprint-rules.md) proposal | **plans/176** Steps 1–3 delivered; Step 4 gated |
