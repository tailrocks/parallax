...
- ~~Exact latest TMA1 release~~ → **pinned v0.2.0-alpha12 (2026-07-17, GitHub API); 5 alpha bumps since alpha7 — fast cadence. Watch triggers still unfired: re-scanned 40 recent commits 2026-07-17 — all install-robustness / hook-plumbing / deps / fs-sensor (incl. a min-GreptimeDB bump v1.0.2→v1.1.2); NONE extend to prod-error-derivation / Sentry / redaction / outcome-loop / CI-deploy. TMA1 remains local-dev-agent-loop scoped; Parallax's prod-incident wedge intact.**
