...
> GitHub **v3.221.1** (2026-07-17) / **31,342★** (pass **220**). **Still
...
>
> **Pass 167/196/220 MCP:** data-platform MCP docs still say **read and write
> tools available by default**; client allowlist for read-only. Does **not** close
