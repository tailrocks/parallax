...
> pass 114; **pass 148** + **pass 176** + **pass 218:** still **v0.62.1 /
> 7,307★** latest tag 2026-06-28; Apache-2.0. ServiceNow / own-store expansion
> **still UNFIRED** — OTel LLM instrumentation SDK + OTLP export only). Sources:
