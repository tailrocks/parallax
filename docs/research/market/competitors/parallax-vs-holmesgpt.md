...
> version pin; **pass 95** Operator-mode; **pass 142** + **pass 177** + **pass
> 217** re-pin + GitHub MCP write surface). Sources:
> [HolmesGPT/holmesgpt (GitHub)](https://github.com/HolmesGPT/holmesgpt)
> (**v0.36.0**, 2026-07-13; **2,874★** pass **217**; Apache-2.0; last push
