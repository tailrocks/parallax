...
- **Sentry envelope/DSN:** Parallax **ships** a Sentry-envelope compatibility ingest (absorb Sentry's 30+ SDKs; plan 118 residual migration). Datadog has no Sentry-envelope path. This remains one of Parallax's genuine wedges against the broad platforms.
