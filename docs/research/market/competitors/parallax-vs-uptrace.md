...
> + **pass 149** + **pass 172** + **pass 218** pin: still **v2.1.0-beta.7**
> latest release 2026-06-05; **4,242★** — quiet vs fast-movers). ClickHouse OTLP
> APM family; **not** portable redacted evidence-bundle product. Sources:
