...
| **AI — Coding Observability / Preflight** | **June 2026: AI Coding Observability** (shipped as open-source **Preflight** 2026-06-23, **no additional cost** beyond standard NR ingest) — Claude Code, Cursor, Copilot, Windsurf, Amazon Q, Zed, Continue.dev, generic MCP clients. **Ground Truth** (June Now): BYO-agent access to NR insights for Copilot/Claude Code/etc. | [press](https://newrelic.com/press-release/20260608), [Preflight blog](https://newrelic.com/blog/news/introducing-ai-coding-observability), [Now June 2026](https://newrelic.com/blog/news/new-relic-now-june-2026-round-up) |
