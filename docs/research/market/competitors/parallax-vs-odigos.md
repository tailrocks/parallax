...
> pricing + marketing; **pass 113** pin recheck; **pass 139** re-pin). Sources:
...
> latest 2026-07-09, **3,668★**, Apache-2.0, push 2026-07-17). **Own-store watch
> still UNFIRED** — still vendor-agnostic **export to destinations**
