...
| [SWE-bench-Live/OS-bench](https://huggingface.co/datasets/SWE-bench-Live/OS-bench) | SHA `53ccce58d8ca4d1273755658d68d4643afadb7de`; last modified `2026-05-23T02:25:29Z`; license tag `cc-by-4.0`; `private=false`, `disabled=false`, `gated=false`; 126 rows in `windows2linux`, 0 rows in `linux2windows`; `partial=false`; `first-rows` returned `truncated=true`. **Drifted 2026-06-09:** new revision `f4a36f778524de13c545f8720d95bfed76ee42e7`, 63 rows — re-pin per the [freeze check](a1-task-source-freeze-check.md) re-verification. | `supplemental_cli_platform`; record the zero-row split and license separately from MIT seed sources. |
