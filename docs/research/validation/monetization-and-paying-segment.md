...
### Pass 329 (2026-07-18) — triangle primary re-scrape

| Vendor | Pin | Holds? |
| --- | --- | --- |
| Grafana Cloud | Pro **$19** + usage; Enterprise **$25,000** commit | **Yes** |
| SigNoz | Teams **$49** + **$0.30/GB** class | **Yes** |
| OpenObserve | **$0.50/GB**; EE free ≤**50 GB/day** | **Yes** |

Desk playbook holds. A2 interviews still **0** rows.

### Pass 336 (2026-07-18) — triangle primary re-scrape
...
### Pass 351 (2026-07-18) — triangle primary re-scrape
...
### Pass 356 (2026-07-18) — SigNoz + OpenObserve pins

SigNoz Teams **$49** and OpenObserve **$0.50/GB** still present. Triangle holds with Grafana $19 (pass 355).

### Pass 359 (2026-07-18) — Grafana $19 pin

Grafana Cloud Pro **$19** class still present. Triangle desk playbook **holds**.

### Pass 362 (2026-07-18) — SigNoz + OpenObserve pins

SigNoz Teams **$49**; OpenObserve free self-host EE ≤**50 GB/day** / **$0.50/GB** class still present. Triangle holds.

### Pass 365 (2026-07-18) — Grafana $19 pin

Grafana Cloud Pro **$19** class still present.

### Pass 367 (2026-07-18) — SigNoz + OpenObserve pins

SigNoz Teams **$49**; OpenObserve **$0.50/GB** class still present. Triangle holds.

### Pass 370 (2026-07-18) — Grafana $19 pin
...
### Pass 388 (2026-07-18) — triangle primary re-scrape
...
### Pass 392 (2026-07-18) — triangle pins

Grafana **$19** / SigNoz **$49** / OO **$0.50** still present. Triangle holds.

### Pass 394 (2026-07-18) — triangle pins

Grafana **$19** / SigNoz **$49** still present. Triangle holds.

### Pass 395 (2026-07-18) — OpenObserve pin

OpenObserve **$0.50/GB** still present. Triangle holds.

### Pass 397 (2026-07-18) — triangle primary re-scrape
...
### Pass 401 (2026-07-18) — triangle pins

Grafana **$19** / SigNoz **$49** / OO **$0.50** still present. Triangle holds.

### Pass 404 (2026-07-18) — triangle primary re-scrape
