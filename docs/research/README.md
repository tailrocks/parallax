...
- [sentry-ingest.md](capture/sentry-ingest.md) — Sentry envelope/Relay/grouping compatibility research; conditional implementation is blocked in [plan 118](../../plans/118-sentry-envelope-migration-adapter.md).
