...
Last updated 2026-07-18 after pass 222 (A1 still **`not_measured`** / no ledger;
A2 still **OPEN / 0 rows**; Bits still **never auto-merges**; GlitchTip
**v6.2.1**; genai#51 idle). Pass 221 = GO reaffirm. A1/A2/A4 open; A6 open at
mixed gate only.
