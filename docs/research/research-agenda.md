...
Last updated 2026-07-18 after pass 191 (SigNoz still **v0.133.0 / 30,296★**;
**Noz = Cloud only**). Pass 190 = auto-merge. A1/A2/A4 open; A6 open at mixed
gate only.
...
- **Engine releases** — re-pin + re-verify load-bearing claims on each new stable (GreptimeDB; ClickHouse feature line). Last: **2026-07-18 pass 187 (API only, no bench)** — GreptimeDB stable **`v1.1.3`** (GitHub **Latest**); latest *named* nightly **release** tag still **`v1.2.0-nightly-20260706`**. ClickHouse **feature** line still **`v26.6.1.1193-stable`** (2026-06-25). Newer **`v26.5.5.8-stable`** (2026-07-01) is a **26.5** patch, **not** the feature-line pin. Server-tier size/cost measurement still owed (agenda #5). **Traces docs GA:**
