...
Last updated 2026-07-17 after pass 143 (Sentry OTLP still **open beta** traces+logs
only; **“does not support OTLP metrics”** — watch UNFIRED). Pass 142 =
HolmesGPT. A1/A2/A4 open; A6 open at mixed gate only.
