...
Last updated 2026-07-17 after pass 122 (Traceway still **1,024★** /
**backend/v1.9.1**; wedge combination **still not closed**). Pass 121 = A4
**`not_measured`**. A1/A2/A4 open; A6 open at mixed-agent gate only.
