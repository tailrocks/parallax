...
Last updated 2026-07-18 after pass 236 (Detect ledger **0** files; `fixer_outcome`
**3/3** pass; A2 ledger **absent**; SWE-bench_Lite **200** — A1 still
**not_measured**). Pass 235 = Phoenix/Coroot/Maple. A1/A2/A4 open; A6 open at
mixed gate only.
