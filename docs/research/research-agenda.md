...
Last updated 2026-07-18 after pass 220 (Datadog OPW still **route-only**; Phoenix
**v18.1.0/10,600★**; Coroot **v1.23.3/7,837★**; Odigos **v1.31.2**; Langfuse
**v3.221.1/31,342★**; HyperDX **2.30.1/9,680★** — none close full wedge). Pass
219 = A3/A4/A6. A1/A2/A4 open; A6 open at mixed gate only.
...
- **Engine releases** — re-pin + re-verify load-bearing claims on each new stable (GreptimeDB; ClickHouse feature line). Last: **2026-07-18 pass 209 (API only, no bench)** — GreptimeDB stable **`v1.1.3`** (GitHub **Latest**); latest *named* nightly **release** tag still **`v1.2.0-nightly-20260706`**. ClickHouse **feature** line still **`v26.6.1.1193-stable`**. Server-tier size/cost measurement still owed (agenda #5). **Traces docs GA:**
  still **experimental** on docs v1.1
  ([Traces overview](https://docs.greptime.com/user-guide/traces/overview/)
  warning reconfirmed pass **209**).
- **Incumbent self-hosted AI** — **Rechecked 2026-07-18 pass 210** (prior 77/126/158/188):
