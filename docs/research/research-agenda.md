...
Last updated 2026-07-18 after pass 159 (A1 still **`not_measured`**: no result
ledger; golden fixture test **ok**; SWE-bench_Lite still live — not a gate).
Pass 158 = Seer/Grafana self-host AI. A1/A2/A4 open; A6 open at mixed gate only.
