...
Last updated 2026-07-17 after pass 74 (Iggy still **server-0.8.0**; clustering issue closed for
inactivity, not HA-ready; local spool product decision holds). Pass 73 = Rust OTel pins. A1/A2/A4/A6
open.
