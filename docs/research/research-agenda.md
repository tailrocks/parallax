...
Last updated 2026-07-18 after pass 176 (Traceloop OpenLLMetry still **v0.62.1 /
7,307★**; ServiceNow/own-store expansion **UNFIRED** — OTel LLM SDK export only).
Pass 175 = Odigos. A1/A2/A4 open; A6 open at mixed gate only.
