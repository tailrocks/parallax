...
Last updated 2026-07-18 after pass 199 (Coroot still **v1.23.3 / 7,837★**; MCP
still **`resolve_alerts`** + EE RCA; eBPF→app-errors **UNFIRED**). Pass 198 =
Phoenix. A1/A2/A4 open; A6 open at mixed gate only.
