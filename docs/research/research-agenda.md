...
Last updated 2026-07-18 after pass 209 (engine pin API-only: GreptimeDB still
**v1.1.3**; CH feature **v26.6.1.1193**; traces still **experimental** — no
size/cost bench). Pass 208 = GlitchTip. A1/A2/A4 open; A6 open at mixed gate only.
