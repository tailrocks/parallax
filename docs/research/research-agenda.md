...
Last updated 2026-07-18 after pass 195 (A6 **split holds**: public-safe canary
**ok**; scanners unchanged; **`agent_visible_mixed_pass` still open**). Pass 194
= A4. A1/A2/A4 open; A6 open at mixed gate only.
