...
Last updated 2026-07-18 after pass 182 (OpenObserve still **v0.91.2 / 20,196★**;
MCP still **mutating** tools; marketing “read-only” **contradicted** by docs).
Pass 181 = TMA1. A1/A2/A4 open; A6 open at mixed gate only.
