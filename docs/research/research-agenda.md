...
Last updated 2026-07-18 after pass 196 (Langfuse still **v3.221.1 / 31,341★**;
MCP **read+write by default** — LLMOps loop, not portable evidence bundle). Pass
195 = A6. A1/A2/A4 open; A6 open at mixed gate only.
