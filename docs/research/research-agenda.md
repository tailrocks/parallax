...
Last updated 2026-07-18 after pass 163 (run-id: genai#51 still idle
**2026-05-05**; OTel still **no** `cli.invocation.id`; product ships it). Pass
162 = engine pin. A1/A2/A4 open; A6 open at mixed gate only.
