...
Last updated 2026-07-18 after pass 186 (loop stages: Detect ledger still
**absent**; `fixer_outcome` **3/3** unit tests pass; live replay **open**). Pass
185 = Traceway. A1/A2/A4 open; A6 open at mixed gate only.
