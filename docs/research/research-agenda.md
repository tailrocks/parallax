...
Last updated 2026-07-17 after pass 100 (A3: Tailrocks schema `$id` still **zero
external refs**; generic `evidence-bundle.v1` filenames elsewhere = **name
collision only**). Pass 99 = closed-loop. A1/A2/A4/A6 open.
