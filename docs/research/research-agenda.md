...
Last updated 2026-07-18 after pass 226 (A6 canary **ok** / mixed open; Seer
**closed**; SO 2026 results **404**; A3 `$id` search **6** in-tree; A4 runs
**absent**). Pass 225 = multi-peer pins. A1/A2/A4 open; A6 open at mixed gate only.
