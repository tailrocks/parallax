...
Last updated 2026-07-18 after pass 162 (engine pin API-only: GreptimeDB
**`v1.1.3`** Latest; named nightly still **`v1.2.0-nightly-20260706`**; CH feature
**`v26.6.1.1193-stable`**; traces docs still **experimental** — no size/cost
bench). Pass 161 = A4. A1/A2/A4 open; A6 open at mixed gate only.
