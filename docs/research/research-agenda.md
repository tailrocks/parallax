...
Last updated 2026-07-17 after pass 123 (OTel #1185 still open/idle
`updated_at` 2025-10-24; no incident/investigation model dir; OCSF still
**1.8.0** — schema **not commoditized**). Pass 122 = Traceway wedge open.
