...
Last updated 2026-07-18 after pass 164 (SigNoz still **v0.133.0 / 30,287★**;
**Noz = Cloud only**; MCP self-host path remains; pricing **$49 + $0.30/GB**).
Pass 163 = run-id. A1/A2/A4 open; A6 open at mixed gate only.
