...
Last updated 2026-07-18 after pass 248 (engine API pins **stable**: GreptimeDB
**v1.1.3** / nightly **20260706**; CH feature **v26.6.1.1193-stable**; traces
still **experimental** — no bench). Pass 247 = A4/A6. A1/A2/A4 open; A6 mixed open.
...
- **Engine releases** — re-pin + re-verify load-bearing claims on each new stable (GreptimeDB; ClickHouse feature line). Last: **2026-07-18 pass 248 (API only, no bench)** — GreptimeDB stable **`v1.1.3`** (GitHub **Latest**); latest *named* nightly **release** tag still **`v1.2.0-nightly-20260706`**. ClickHouse **feature** line still **`v26.6.1.1193-stable`** (do not pin **26.5.x** maintenance as feature tip). Server-tier size/cost measurement still owed (agenda #5). **Traces docs:**
  still **experimental** on docs v1.1
  ([Traces overview](https://docs.greptime.com/user-guide/traces/overview/)
  warning reconfirmed pass **248**).
