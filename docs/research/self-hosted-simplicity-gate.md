...
| OTLP proof | OTLP HTTP/gRPC path accepts the sample trace/log/metric without deploying a separate collector. | If an external collector is mandatory for the tiny tier, document why or defer the claim. |
