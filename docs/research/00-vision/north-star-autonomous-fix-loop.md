...
| --- | --- | --- |
| Sentry Seer | Root cause → solution → code changes → **opens PR** (cap: **Stop after PR Drafted**); external coding-agent handoff | **No app-code auto-merge** — max auto is PR draft/create ([Autofix docs](https://docs.sentry.io/product/ai-in-sentry/seer/autofix/) pass **165/190/212**) |
| Datadog Bits AI | Bits Code: fix gen + CI iterate + open PR/MR; automations optional | **Never auto-merges** ([Bits Code docs](https://docs.datadoghq.com/bits_ai/bits_code/) pass **165/190/212**); humans decide merge |
