...
> "Sentry-compatible" wording still requires current SDK-generated fixtures to pass parser,
> normalization, grouping, redaction, source-field, idempotency, trace-correlation,
...
day one. If the adapter ships later, expose it as:
