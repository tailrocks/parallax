...
> **Implementation status (2026-07-17):** `parallax-redaction` implements the
> owned Rust detector engine (`redaction-lite-v3` / `detectors-v1`), default-deny
> source decisions, `REDACTION_POLICY_V1`, `RedactionReport`, `redact`, `decide`,
> `project_text`, and `sanitize_text`. It runs during metadata/bundle projection,
> deliberately not on the zero-copy ingest hot path.
>
> **Pass 120 claim-level split (2026-07-17):** do **not** treat A6 as a single
> boolean. Per claim table below:
>
> | Tier | Status | Evidence |
> | --- | --- | --- |
> | Engine + unit canaries | **`synthetic_canary_pass` (partial)** | Plan 111 DONE public-safe canary table; `a6_public_safe_canaries_are_not_projected_raw_by_detectors` and related tests in `parallax-redaction` |
> | Formal multi-surface red-team ledger | **Still open** | No dated `redaction-red-team-results.md` / multi-encoding / MCP `structuredContent` / offline multi-scanner matrix run under this note's contract |
> | Product wording for third-party models | **Not `agent_visible_mixed_pass`** | Plan 111 "measured" = detector unit + public-safe canaries **≠** full agent-visible mixed gate |
>
> Agenda "A6 open" means the **full trust claim** remains open; it does **not**
> mean the redaction engine is absent.
>
> **Pass 63 offline-comparator re-pin (2026-07-17, GitHub releases API):**
>
> | Tool | May note | 2026-07-17 pin | Delta |
> | --- | --- | --- | --- |
> | Gitleaks | v8.30.1 | **v8.30.1** (2026-03-21) | unchanged |
> | Betterleaks | v1.3.1 | **v1.6.1** (2026-06-30) | **bumped** — re-read changelog before red-team CI pin |
> | TruffleHog | v3.95.3 | **v3.95.9** (2026-07-09) | **patch bump** |
> | detect-secrets | v1.5.0 | **v1.5.0** (2024-05-06) | unchanged (slow cadence) |
> | Presidio | 2.2.362 | **2.2.363** (2026-06-28) | **patch bump** |
>
> **Pass 105 (2026-07-17):** pins **unchanged** vs pass 63.
>
> **Pass 120 (2026-07-17):** GitHub/PyPI latest re-pin **unchanged** vs pass 105
> (Gitleaks **v8.30.1**, Betterleaks **v1.6.1**, TruffleHog **v3.95.9**,
> detect-secrets **v1.5.0**, Presidio **2.2.363**). Offline comparators only;
> **no** new formal red-team results file this pass.
>
> Full status note: [a6-claim-status-recheck-2026-07-17.md](../validation/a6-claim-status-recheck-2026-07-17.md).
...
| [Gitleaks v8.30.1](https://github.com/gitleaks/gitleaks/releases/tag/v8.30.1) | Latest release rechecked **2026-07-17**; still `v8.30.1` (2026-03-21). Feature-complete posture unchanged. | Best stable comparator for Phase 0 fixture scanning; not runtime path. |
| [Betterleaks v1.6.1](https://github.com/betterleaks/betterleaks/releases/tag/v1.6.1) | Rechecked **2026-07-17**: latest **`v1.6.1`** (2026-06-30) — **supersedes May pin v1.3.1**. Re-pin checksums/report schema before CI. | Experimental active comparator; validation/network/LLM off by default; never runtime path. |
| [TruffleHog v3.95.9](https://github.com/trufflesecurity/trufflehog/releases/tag/v3.95.9) | Rechecked **2026-07-17**: latest **`v3.95.9`** (2026-07-09) — **supersedes May pin v3.95.3**. AGPL-3.0. | Red-team comparator only; credential verification network side-effects. |
| [Yelp detect-secrets v1.5.0](https://github.com/Yelp/detect-secrets/releases/tag/v1.5.0) | Rechecked **2026-07-17**: still `v1.5.0` (2024-05-06). | Secondary baseline comparator. |
| [Microsoft Presidio 2.2.363](https://github.com/microsoft/presidio/releases/tag/2.2.363) | Rechecked **2026-07-17**: latest **`2.2.363`** (2026-06-28) — **supersedes 2.2.362**. | Offline PII reference; not sole runtime guarantee. |
