...
>
> **Pass 162 + pass 187 (2026-07-18) — version pin only (no size/cost bench):**
> GitHub `releases/latest` still **GreptimeDB `v1.1.3`**. Latest named nightly
> **release** tag still **`v1.2.0-nightly-20260706`**. ClickHouse feature pin
> still **`v26.6.1.1193-stable`**; `v26.5.5.8-stable` is 26.5 patch only. Traces
> overview docs v1.1 still **experimental** (pass **187** HTML). **A5 remains
> unproven** — pin hygiene ≠ sized-cost pass.
