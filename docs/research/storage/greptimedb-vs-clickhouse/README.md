...
| quota+PREWHERE+increase | **498** | holds; increase no |
...
| still not done | **503** | top 5 open |
| last_value four-way | **504** | GT 11–21ms / CH 5–6ms |
| still not done | **505** | top 5 open |
| re-pin + healthy | **506** | no newer nightly |
| still not done | **507** | top 5 open |
| rate+identity+agg | **508** | holds |
| still not done | **509** | top 5 open |
| proj+FT+PK triple | **510** | all hold |
| still not done | **511** | top 5 open |
...
| last_value+rate | **516** | warm 8ms; rate 1.5 |
| still not done | **517** | top 5 open |
| pins+health+Jaeger | **518** | all healthy |
...
| still not done | **539** | top 5 open |
| milestone 540 | **540** | healthy; rate 1.5; not done |
| still not done | **541** | top 5 open |
...
| pins+health+adopt | **546** | all healthy |
| still not done | **547** | top 5 open |
| rate increase append | **548** | rate OK; increase/DELETE no |
...
| still not done | **569** | top 5 product/server |
| Flow r228 live | **570** | SHOW FLOWS still 2 |
...
| still not done | **575** | top 5 product/server |
| rate OK increase no | **576** | rate=1.0; Code 48; health 200 |
...
| still not done | **583** | top 5 product/server |
| join + OTLP | **584** | PK+bloom 1/1; protobuf-only |
...
| still not done | **601** | top 5 product/server |
| four-way last_value | **602** | GT~8ms / CH~3ms warm |
...
| export + DELETE ban | **608** | 647 lines; Code 1004 |
| still not done | **609** | top 5 product/server |
| FT + PREWHERE + adopt | **610** | 0/7; 2/7; Jaeger/Prom 200 |
...
| re-pin hold | **616** | pins; healthy |
| still not done | **617** | top 5 product/server |
| identity join OTLP | **618** | holds |
| still not done | **619** | top 5 product/server |
| milestone 620 | **620** | pins/healthy; NOT DONE |
| still not done | **621** | top 5 product/server |
| rate/increase | **622** | rate OK; increase 48 |
...
| re-pin hold | **636** | v1.1.3/26.6 healthy |
| still not done | **637** | top 5 product/server |
...
| still not done | **643** | top 5 product/server |
| PREWHERE + p_svc | **644** | 2/7; projection serves |
...
| still not done | **653** | top 5 product/server |
| rate/increase | **654** | rate OK; increase 48 both |
| still not done | **655** | top 5 product/server |
| re-pin hold | **656** | pins; healthy ~3h+ |
| still not done | **657** | top 5 product/server |
...
| re-pin hold | **666** | pins healthy |
| still not done | **667** | top 5 product/server |
...
| re-pin hold | **676** | pins healthy |
| still not done | **677** | top 5 product/server |
| identity join increase | **678** | holds; Code 48 |
| still not done | **679** | top 5 product/server |
...
| rate export OTLP | **691** | holds |
| still not done | **692** | top 5 product/server |
| still not done | **693** | top 5 product/server |
| re-pin hold | **694** | pins unchanged |
| still not done | **695** | top 5 product/server |
| join PREWHERE FT | **696** | granules hold |
| still not done | **697** | top 5 product/server |
| last_value rate health | **698** | holds |
| still not done | **699** | top 5 product/server |
| milestone 700 | **700** | pins/healthy; NOT DONE |
| identity increase Jaeger | **701** | holds; Code 48; 200 |
| still not done | **702** | top 5 product/server |
...
| last_value p_svc rate | **708** | holds |
| still not done | **709** | top 5 product/server |
| milestone 710 | **710** | NOT DONE |
| re-pin hold | **711** | pins healthy ~3h+ |
| still not done | **712** | top 5 product/server |
| still not done | **713** | top 5 product/server |
| adopt DELETE OTLP | **714** | holds |
| still not done | **715** | top 5 product/server |
| last_value join increase | **716** | holds; Code 48 |
| still not done | **717** | top 5 product/server |
| re-pin hold | **718** | pins healthy |
| still not done | **719** | top 5 product/server |
...
| last_value p_svc DELETE | **731** | holds |
| still not done | **732** | top 5 product/server |
...
| re-pin hold | **746** | pins unchanged |
| still not done | **747** | top 5 product/server |
| last_value Jaeger DELETE | **748** | holds |
| still not done | **749** | top 5 product/server |
...
| increase + health | **756** | Code 48; 200 |
| still not done | **757** | top 5 product/server |
| last_value join identity | **758** | holds |
| still not done | **759** | top 5 product/server |
| milestone 760 | **760** | NOT DONE |
