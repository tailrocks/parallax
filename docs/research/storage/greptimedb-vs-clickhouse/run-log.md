...
cold/first-run measurement showed). 32 mechanism + synthesis notes + 171 local runs + B1–B15 cases. Recent: **Run 760 — milestone NOT DONE**. **Run 759 — comparison still not done**. **Run 758 — last_value + join + identity**. **Run 757 — comparison still not done**. **Run 756 — increase Code 48 + health**. **Run 755 — comparison still not done**. **Run 754 — re-pin hold; four-way healthy**. **Run 753 — comparison still not done**. **Run 752 — comparison still not done**. **Run 751 — p_svc + rate + export-v2**. **Run 750 — milestone NOT DONE**. **Run 749 — comparison still not done**. **Run 748 — last_value + Jaeger + append DELETE**. **Run 747 — comparison still not done**. **Run 746 — re-pin hold; pins v1.1.3/26.6/26.7**. **Run 745 — comparison still not done**. **Run 744 — Flow + FT + PREWHERE + OTLP**. **Run 743 — comparison still not done**. **Run 742 — comparison still not done**. **Run 741 — re-pin hold; four-way healthy ~3h+**. **Run 740 — milestone NOT DONE**. **Run 739 — comparison still not done**. **Run 738 — last_value + rate + increase Code 48**. **Run 737 — comparison still not done**. **Run 736 — identity + join + Jaeger**. **Run 735 — comparison still not done**. **Run 734 — re-pin hold; four-way healthy**. **Run 733 — comparison still not done**. **Run 732 — comparison still not done**. **Run 731 — last_value + p_svc + append DELETE**. **Run 730 — milestone NOT DONE**. **Run 729 — comparison still not done**. **Run 728 — rate + increase Code 48 + health 200**. **Run 727 — comparison still not done**. **Run 726 — re-pin hold; pins v1.1.3/26.6/26.7**. **Run 725 — comparison still not done**. **Run 724 — last_value + export-v2 + Jaeger 200**. **Run 723 — comparison still not done**. **Run 722 — comparison still not done**. **Run 721 — FT 0/7 PREWHERE 2/7 Flow r228**. **Run 720 — milestone NOT DONE**. **Run 719 — comparison still not done**. **Run 718 — re-pin hold; four-way healthy**. **Run 717 — comparison still not done**. **Run 716 — last_value + join + increase Code 48**. **Run 715 — comparison still not done**. **Run 714 — identity Jaeger OTLP DELETE hold**. **Run 713 — comparison still not done**. **Run 712 — comparison still not done**. **Run 711 — re-pin hold; four-way healthy ~3h+**. **Run 710 — milestone NOT DONE**. **Run 709 — comparison still not done**. **Run 708 — last_value warm + p_svc + rate**. **Run 707 — comparison still not done**. **Run 706 — Flow + export-v2 + append DELETE**. **Run 705 — comparison still not done**. **Run 704 — re-pin hold; four-way healthy**. **Run 703 — comparison still not done**. **Run 702 — comparison still not done**. **Run 701 — identity + increase Code 48 + Jaeger 200**. **Run 700 — milestone pins/healthy NOT DONE**. **Run 699 — comparison still not done**. **Run 698 — last_value + rate + health 200**. **Run 697 — comparison still not done**. **Run 696 — join prune + PREWHERE + FT hold**. **Run 695 — comparison still not done**. **Run 694 — re-pin hold; pins v1.1.3/26.6/26.7**. **Run 693 — comparison still not done**. **Run 692 — comparison still not done**. **Run 691 — rate OK; export-v2 OK; OTLP 400**. **Run 690 — milestone NOT DONE**. **Run 689 — comparison still not done**. **Run 688 — four-way last_value warm GT~ms / CH~ms**. **Run 687 — comparison still not done**. **Run 686 — p_svc + Jaeger + append DELETE**. **Run 685 — comparison still not done**. **Run 684 — re-pin hold; four-way healthy ~3h+**. **Run 683 — comparison still not done**. **Run 682 — comparison still not done**. **Run 681 — last_value + Flow + FT 0/7**. **Run 680 — milestone NOT DONE**. **Run 679 — comparison still not done**. **Run 678 — identity + join + increase Code 48**. **Run 677 — comparison still not done**. **Run 676 — re-pin hold; four-way healthy**. **Run 675 — comparison still not done**. **Run 674 — export-v2 + last_value warm**. **Run 673 — comparison still not done**. **Run 672 — comparison still not done**. **Run 671 — rate + join + PREWHERE hold**. **Run 670 — milestone NOT DONE**. **Run 669 — comparison still not done**. **Run 668 — adopt-native + append DELETE + Jaeger**. **Run 667 — comparison still not done**. **Run 666 — re-pin v1.1.3/26.6/26.7; four-way healthy**. **Run 665 — comparison still not done**. **Run 664 — last_value ~5ms; increase Code 48**. **Run 663 — comparison still not done**. **Run 662 — comparison still not done**. **Run 661 — join prune + p_svc + health 200**. **Run 660 — milestone NOT DONE**. **Run 659 — comparison still not done**. **Run 658 — Flow + export-v2 + FT 0/7**. **Run 657 — comparison still not done**. **Run 656 — re-pin hold; four-way healthy ~3h+**. **Run 655 — comparison still not done**. **Run 654 — rate OK increase Code 48 both CH**. **Run 653 — comparison still not done**. **Run 652 — comparison still not done**. **Run 651 — identity schema-on-write + OTLP 400**. **Run 650 — milestone pins/healthy NOT DONE**. **Run 649 — comparison still not done**. **Run 648 — last_value warm + append DELETE 1004**. **Run 647 — comparison still not done**. **Run 646 — re-pin hold; Jaeger/Prom 200**. **Run 645 — comparison still not done**. **Run 644 — PREWHERE 2/7 + p_svc projection**. **Run 643 — comparison still not done**. **Run 642 — comparison still not done**. **Run 641 — export-v2 + increase Code 48**. **Run 640 — milestone healthy pins NOT DONE**. **Run 639 — comparison still not done**. **Run 638 — last_value + join prune hold**. **Run 637 — comparison still not done**. **Run 636 — re-pin v1.1.3/26.6; four-way healthy**. **Run 635 — comparison still not done**. **Run 634 — rate 0.25; Flow r228 live**. **Run 633 — comparison still not done**. **Run 632 — comparison still not done**. **Run 631 — identity+Jaeger+append DELETE hold**. **Run 630 — milestone pins hold NOT DONE**. **Run 629 — comparison still not done**. **Run 628 — FT PREWHERE join hold**. **Run 627 — comparison still not done**. **Run 626 — four-way health 200; last_value warm**. **Run 625 — comparison still not done**. **Run 624 — export-v2 + p_svc projection hold**. **Run 623 — comparison still not done**. **Run 622 — rate OK increase Code 48**. **Run 621 — comparison still not done**. **Run 620 — milestone: pins hold, healthy ~3h+, load-bearing holds re-verified; NOT DONE**. **Run 619 — comparison still not done**. **Run 618 — identity+join+OTLP hold**. **Run 617 — comparison still not done**. **Run 616 — re-pin hold; four-way healthy**. **Run 615 — comparison still not done**. **Run 614 — last_value warm recheck; increase still Code 48**. **Run 613 — comparison still not done**. **Run 612 — last_value warm GT~7ms; Flow r228 live**. **Run 611 — comparison still not done**. **Run 610 — FT 0/7 + PREWHERE 2/7 + Jaeger/Prom 200**. **Run 609 — comparison still not done**. **Run 608 — export-v2 647 lines; append DELETE 1004**. **Run 607 — comparison still not done**. **Run 606 — re-pin hold; four-way healthy ~3h+**. **Run 605 — comparison still not done**. **Run 604 — join prune PK+bloom 1/1**. **Run 603 — comparison still not done**. **Run 602 — four-way last_value warm GT~8–9ms / CH~3ms (nightly cold 276ms)**. **Run 601 — comparison still not done**. **Run 600 — milestone pins/healthy/identity/Jaeger; NOT DONE**. **Run 599 — comparison still not done**. **Run 598 — identity Int64+String schema-on-write; Jaeger 200**. **Run 597 — comparison still not done**. **Run 596 — increase Code 48 on 26.6+26.7; health 200**. **Run 595 — comparison still not done**. **Run 594 — p_svc projection + rate still OK**. **Run 593 — comparison still not done**. **Run 592 — Flow r228 + export-v2 635 lines OK**. **Run 591 — comparison still not done**. **Run 590 — milestone: pins hold, healthy, Jaeger/Prom 200, last_value ~5ms; NOT DONE**. **Run 589 — comparison still not done**. **Run 588 — PREWHERE 2/7; FT msg0 0/7 error 7/7**. **Run 587 — comparison still not done**. **Run 586 — append DELETE 1004; four-way health 200**. **Run 585 — comparison still not done**. **Run 584 — join prune PK+bloom 1/1; OTLP 400**. **Run 583 — comparison still not done**. **Run 582 — identity Boolean schema-on-write; last_value warm GT~5ms**. **Run 581 — comparison still not done**. **Run 580 — re-pin hold v1.1.3 / 26.6 / head 26.7; four-way healthy ~3h+; NOT DONE**. **Run 579 — comparison still not done**. **Run 578 — export-v2 schema OK (public.sql 623 lines); Jaeger 200**. **Run 577 — comparison still not done**. **Run 576 — sum(rate)=1.0; increase Code 48; four-way health 200**. **Run 575 — comparison still not done**. **Run 574 — r430_ttl still 0 (TTL expire holds)**. **Run 573 — comparison still not done**. **Run 572 — TimeSeries not supported in ClickHouse Cloud (docs)**. **Run 571 — comparison still not done**. **Run 570 — Flow r228_* still listed**. **Run 569 — comparison still not done**. **Run 568 — re-pin hold; four-way healthy; Jaeger/Prom 200; last_value GT~8–9ms / CH~3ms**. **Run 567 — comparison still not done**. **Run 566 — append DELETE 1004; freshness 1→2; CH lw DELETE 2→1**. **Run 565 — CH projection p_svc still ReadFromMergeTree(p_svc)**. **Run 564 — comparison still not done (top 5 product/server open)**. **Run 563 — FT tokenbf msg0 0/7 vs error 7/7; PREWHERE service 2/7**. **Run 562 — adopt-native + join prune no drift (OTLP 400; identity k2 auto; PK+bloom 1/1)**. **Run 561 — still not done; pins hold; GT TQL increase → prom_increase plan**. **Run 560 — CH PromQL matrix re-smoke: rate/topk/last/delta OK; increase+*_over_time Code 48; range-offset Code 43 type bug**. **Run 559 — D1 re-smoke: CH BACKUP/RESTORE m2m 50k ROW_MATCH; GT export-v2 schema + COPY parquet OK**. **Run 558 — ops burden note (gap #7 engine layer); raft-engine D2 still fails; managed list rates hold; identity/Jaeger/Prom OK; last_value GT~8ms / CH~3ms**. **Run 557 — comparison still not done**. **Run 556 — four-way healthy; pins hold; Jaeger/Prom 200**. **Run 555 — comparison still not done**. **Run 554 — last_value/agg OK; rate 1.5; increase Code 48**. **Run 553 — comparison still not done**. **Run 552 — PK prune + identity + export-v2 all OK**. **Run 551 — comparison still not done**. **Run 550 — milestone: pins hold, healthy, rate 1.5, last_value 9ms; NOT DONE**. **Run 549 — comparison still not done**. **Run 548 — sum(rate)=1.5; increase Code 48; append DELETE 1004**. **Run 547 — comparison still not done**. **Run 546 — pins hold; four-way healthy; Jaeger/Prom 200; last_value OK**. **Run 545 — comparison still not done**. **Run 544 — join+FT+projection all still hold**. **Run 543 — comparison still not done**. **Run 542 — export-v2 OK; increase Code 48; TTL 0**. **Run 541 — comparison still not done**. **Run 540 — pins hold; four-way healthy; Jaeger/Prom 200; sum(rate)=1.5; NOT DONE**. **Run 539 — comparison still not done**. **Run 538 — distinct/row_number/p99 all interactive on GT**. **Run 537 — comparison still not done**. **Run 536 — four-way healthy; pins hold; last_value interactive**. **Run 535 — comparison still not done**. **Run 534 — join prune + freshness 3 + Flow r228 live**. **Run 533 — comparison still not done**. **Run 532 — sum(rate)=1.5; increase Code 48; last_value OK**. **Run 531 — comparison still not done**. **Run 530 — adopt-native: Jaeger/Prom 200; identity schema-on-write**. **Run 529 — comparison still not done**. **Run 528 — re-pin hold v1.1.3; four-way healthy ~2h+**. **Run 527 — comparison still not done**. **Run 526 — FT 0/7 + PREWHERE 2/7 + p_svc all hold**. **Run 525 — comparison still not done**. **Run 524 — last_value warm GT ~10–14 ms / CH ~5–7 ms**. **Run 523 — comparison still not done**. **Run 522 — export-v2 OK; append DELETE 1004; PK prune 1/1**. **Run 521 — comparison still not done**. **Run 520 — topk still OK; increase still Code 48 on head**. **Run 519 — comparison still not done**. **Run 518 — pins hold; four-way healthy; Jaeger 200**. **Run 517 — comparison still not done**. **Run 516 — last_value warm 8ms (cold 1448ms); sum(rate)=1.5**. **Run 515 — comparison still not done**. **Run 514 — four-way healthy ~2h+; pins; Jaeger+Prom 200**. **Run 513 — comparison still not done**. **Run 512 — Flow live; TTL 0; increase still Code 48**. **Run 511 — comparison still not done**. **Run 510 — projection + FT 0/7 + PK 1/1 all hold**. **Run 509 — comparison still not done**. **Run 508 — sum(rate)=1.5; identity schema-on-write; agg OK**. **Run 507 — comparison still not done**. **Run 506 — re-pin hold; nightly still 20260713; four-way healthy ~2h+**. **Run 505 — comparison still not done**. **Run 504 — four-way last_value warm GT ~11–21 ms / CH ~5–6 ms**. **Run 503 — comparison still not done**. **Run 502 — join prune + append DELETE 1004 + freshness 3**. **Run 501 — comparison still not done**. **Run 500 — milestone: pins hold, four-way healthy, last_value interactive; NOT DONE**. **Run 499 — comparison still not done (triple-digit approach)**. **Run 498 — quota default present; PREWHERE 2/7; increase still missing**. **Run 497 — comparison still not done**. **Run 496 — adopt-native + export-v2 + pins hold**. **Run 495 — comparison still not done**. **Run 494 — p99 panel warm GT ~14–18 ms / CH ~4–5 ms**. **Run 493 — comparison still not done**. **Run 492 — row_number top-3 warm GT ~29–38 ms / CH ~6–16 ms**. **Run 491 — comparison still not done**. **Run 490 — count-distinct warm GT ~10–11 ms / CH ~9–35 ms; both 50k**. **Run 489 — comparison still not done**. **Run 488 — TimeSeries topk + last_over_time still OK on 26.6+head**. **Run 487 — comparison still not done; ranking 423–486**. **Run 486 — four-way healthy; pins hold; Jaeger+Prom 200**. **Run 485 — comparison still not done**. **Run 484 — TTL tables still empty (0 rows); ttl=1s option holds**. **Run 483 — comparison still not done**. **Run 482 — anchored prune holds; four containers healthy**. **Run 481 — comparison still not done**. **Run 480 — increase still Code 48; pins hold; health 200**. **Run 479 — comparison still not done**. **Run 478 — FT tokenbf still msg0 0/7 vs error 7/7**. **Run 477 — comparison still not done**. **Run 476 — metric-agg warm GT ~8–9 ms / CH ~3 ms**. **Run 475 — comparison still not done**. **Run 474 — Flow r228_* + CH MV still live; pin v1.1.3 hold**. **Run 473 — comparison still not done**. **Run 472 — projection p_svc still serves on 26.6+head after 2h**. **Run 471 — comparison still not done**. **Run 470 — adopt-native + pins hold; identity schema-on-write; OTLP 400**. **Run 469 — comparison still not done**. **Run 468 — four-way last_value warm after ~2h: GT ~10–12 ms / CH ~4–5 ms**. **Run 467 — comparison still not done**. **Run 466 — append DELETE still Code 1004; four-way healthy ~2h**. **Run 465 — comparison still not done**. **Run 464 — freshness 1→2 both engines no drift**. **Run 463 — comparison still not done**. **Run 462 — time-range filter on aged spans1m returns 0; both engines ~3ms warm**. **Run 461 — comparison still not done**. **Run 460 — sum(rate) still 1.5 both CH builds; increase still Code 48**. **Run 459 — comparison still not done**. **Run 458 — CH join prune still PK+bloom both sides (~5 ms)**. **Run 457 — comparison still not done**. **Run 456 — export-v2 schema-only OK (public.sql 508 lines)**. **Run 455 — comparison still not done**. **Run 454 — pins hold; Jaeger+Prom 200; four-way healthy ~2h**. **Run 453 — comparison still not done**. **Run 452 — p50/p99 panel: GT ~13–14 ms / CH ~3 ms warm (multi-percentile)**. **Run 451 — comparison still not done**. **Run 450 — row_number top-3 per service: GT ~21–22 ms / CH ~5 ms warm**. **Run 449 — comparison still not done**. **Run 448 — count-distinct: GT exact 50k ~13–15ms / approx_distinct 49972 ~6–8ms; CH exact+uniq ~6–16ms**. **Run 447 — re-pin hold; latest nightly still 20260713; not done**. **Run 446 — CH ACCESS still has quotas/profiles/row policies surface**. **Run 445 — comparison still not done**. **Run 444 — anchored trace_id N=2k: GT ~3–5 ms / CH ~2–4 ms; both prune**. **Run 443 — comparison still not done**. **Run 442 — four-way healthy; spans1m service=s0 count 4167 match GT/CH**. **Run 441 — CH density dirty fixtures: logs1m 23 B/row, spans 10, m2m 4.5**. **Run 440 — still not done; top 5 product/server**. **Run 439 — pins hold; increase + min_over_time still Code 48 on head; rate OK**. **Run 438 — TWCS option holds; CH PREWHERE service s0 2/7 granules (dirty parts)**. **Run 437 — comparison still not done (pins hold; top 5 product/server)**. **Run 436 — Flow r228_* still listed; sink lag src 4→3 (async)**. **Run 435 — append DELETE Code 1004; CH lw DELETE 2→1; freshness 1→2**. **Run 434 — adopt-native: Jaeger 200, identity schema-on-write, OTLP protobuf-only, CH no otel engine**. **Run 433 — ranking 423–432; not done**. **Run 432 — CH projection p_svc serves GROUP BY service on 26.6+26.7 (ReadFromMergeTree p_svc 1/1)**. **Run 431 — SQL metric-agg warm GT ~8–11 ms / CH ~3–8 ms; TQL on m2m empty (val≠greptime_value)**. **Run 430 — TTL expire holds: GT compact→0; CH MATERIALIZE TTL+OPTIMIZE 2→1**. **Run 429 — four-way metric-agg warm: GT ~7–9 ms / CH ~2–7 ms; nightly cold first-hit ~254 ms**. **Run 428 — FT: CH tokenbf msg0 0/7 granules; broad error/timeout 7/7; GT FULLTEXT bloom present**. **Run 427 — re-pin hold v1.1.3 / 26.6.1.1193 / head 26.7.1.1097; not done**. **Run 426 — default JSON+json_get_string works @200 (~4–5 ms filter); SQL type JSONB unsupported; JSON2 string INSERT type-mismatch (known); CH JSON ~2–3 ms**. **Run 425 — four-way warm last_value/argMax @~50k: GT ~10–16 ms / CH ~4–11 ms (~1–3×); cold nightly first hit 278 ms artifact**. **Run 424 — CH join pushes trace_id to both sides (PK+bloom); GT PK filter prunes; join-pushdown thesis holds**. **Run 423 — expanded CH PromQL matrix: rate/agg/topk/last OK; increase + most *_over_time + deriv/resets/absent Code 48; GT has rollups**. **Run 422 — logs1m bloom idx_trace 2/7 granules on trace_id=t0 (CH; counts dirty from concurrent inserts)**. **Run 421 — comparison still not done (pins hold; top gaps product/server)**. **Run 420 — query under concurrent insert still ms (logs1m service filter CH 4ms / GT 7ms)**. **Run 419 — bump impl-note pin headers to v1.1.3 / 26.6 (historical Run 45/46 kept)**. **Run 418 — fix stale 'no PromQL' in clickhouse-implementation; TimeSeries 3-target facade note**. **Run 417 — TWCS table still `'compaction.type'='twcs'`; 2 files present; partition scan single-region (no drift)**. **Run 416 — gap ranking after 403–415; not done**. **Run 415 — Flow catalog still has r228_flow*; CH SummingMergeTree MV live (async lag sink 3 vs src 4)**. **Run 414 — append_mode DELETE Code 1004; CH lightweight DELETE 2→1 (no drift)**. **Run 413 — freshness visible-on-write 1→2 both engines (no drift)**. **Run 412 — last_value/argMax still live on m2m (~50k; GT 1020 groups vs CH 1000 — GT has +20 concurrent-test rows)**. **Run 411 — increase still Code 48 even with time_series_aggregate_functions=1; no IncreaseToGrid**. **Run 410 — re-pin hold v1.1.3/26.6; PREWHERE PK 1/6 granules on logs1m service=s0 (no drift)**. **Run 409 — D3 SQLite dump/restore pattern ROW_MATCH (stand-in schema)**. **Run 408 — gap ranking after 403–407; not done**. **Run 407 — native OTEL tables auto-create-on-ingest only (empty catalog until OTLP)**. **Run 406 — adopt-native OTEL/identity/Jaeger re-verify no drift (protobuf-only OTLP; identity schema-on-write)**. **Run 405 — managed list rates hold; D2 meta snapshot CLI not usable on standalone raft-engine; export-v2 schema-only OK**. **Run 404 — CH PromQL completeness: rate/sum/avg by match GT; increase Code 48 on 26.6+26.7**. **Run 403 — CH TimeSeries INSERT+prometheusQuery real (drift: outer SELECT Code 48 is facade-by-design, not broken PromQL; 26.6.1+26.7.1)**. **Run 402 — health OK**. **Run 401 — not done**. **Run 400 — marker**. **Run 399 — not done**. **Run 398 — healthy ~1h**. **Run 397 — not done**. **Run 396 — README remaining**. **Run 395 — not done**. **Run 394 — health+anchored**. **Run 393 — remaining work table**. **Run 392 — not done**. **Run 391 — still 1.1.3**. **Run 390 — not done**. **Run 389 — health OK**. **Run 388 — not done**. **Run 387 — not done**. **Run 386 — anchored idle**. **Run 385 — not done**. **Run 384 — healthy 1h**. **Run 383 — not done**. **Run 382 — CH versions**. **Run 381 — not done**. **Run 380 — health OK**. **Run 379 — not done**. **Run 378 — not done**. **Run 377 — anchored sample**. **Run 376 — not done**. **Run 375 — healthy 59m**. **Run 374 — health+version**. **Run 373 — not done**. **Run 372 — GT service PK**. **Run 371 — not done**. **Run 370 — CH service filter**. **Run 369 — not done**. **Run 368 — health OK**. **Run 367 — not done**. **Run 366 — spans 50k**. **Run 365 — top 5 gaps**. **Run 364 — not done**. **Run 363 — TimeSeries Code 48**. **Run 362 — not done**. **Run 361 — nightly JSON2**. **Run 360 — not done**. **Run 359 — m2m grew**. **Run 358 — not done**. **Run 357 — anchored warm**. **Run 356 — session status**. **Run 355 — not done**. **Run 354 — anchored idle**. **Run 353 — not done**. **Run 352 — healthy 52m**. **Run 351 — not done**. **Run 350 — p99**. **Run 349 — still not done**. **Run 348 — not done**. **Run 347 — metric bucketed**. **Run 346 — not done**. **Run 345 — re-pin**. **Run 344 — not done**. **Run 343 — FT broad**. **Run 342 — not done**. **Run 341 — high-group-agg**. **Run 340 — not done**. **Run 339 — explorer sort**. **Run 338 — not done**. **Run 337 — ERROR filter**. **Run 336 — not done**. **Run 335 — topk**. **Run 334 — not done**. **Run 333 — unindexed span_id**. **Run 332 — not done**. **Run 331 — time-range**. **Run 330 — not done**. **Run 329 — latency buckets**. **Run 328 — not done**. **Run 327 — pins hold**. **Run 326 — not done**. **Run 325 — join after indexes**. **Run 324 — not done**. **Run 323 — state live**. **Run 322 — not done**. **Run 321 — freshness 20/20**. **Run 320 — healthy not done**. **Run 319 — not done**. **Run 318 — append DELETE**. **Run 317 — head hold**. **Run 316 — not done**. **Run 315 — CH density**. **Run 314 — not done**. **Run 313 — logs indexes**. **Run 312 — not done**. **Run 311 — tsr avg**. **Run 310 — not done**. **Run 309 — JSON2 path**. **Run 308 — execute ranking**. **Run 307 — healthy 37m**. **Run 306 — not done**. **Run 305 — counter range**. **Run 304 — not done**. **Run 303 — issue-list**. **Run 302 — not done**. **Run 301 — no LowCardinality**. **Run 300 — triple-digit**. **Run 299 — health OK**. **Run 298 — m2m cardinality**. **Run 297 — healthy continue**. **Run 296 — log-tail**. **Run 295 — not done**. **Run 294 — FT selective**. **Run 293 — still open**. **Run 292 — CH FS cache metrics**. **Run 291 — mito cache metrics**. **Run 290 — TimeSeries still Code 48**. **Run 289 — not done**. **Run 288 — Flow persists**. **Run 287 — OTLP note fold**. **Run 286 — OTLP endpoint**. **Run 285 — CH head bloom**. **Run 284 — open gap table**. **Run 283 — errs inverted**. **Run 282 — multi-tenancy note**. **Run 281 — errs last_value**. **Run 280 — milestone 220–279**. **Run 279 — metric-agg under insert**. **Run 278 — re-pin still current**. **Run 277 — recursive CTE**. **Run 276 — B10 status**. **Run 275 — PREWHERE+bloom**. **Run 274 — not done**. **Run 273 — four-way after logs index**. **Run 272 — join prune after fix**. **Run 271 — harness logs.trace_id**. **Run 270 — ALTER logs.trace_id index**. **Run 269 — logs schema audit**. **Run 268 — gap ranking**. **Run 267 — row_number**. **Run 266 — approx distinct**. **Run 265 — count-distinct**. **Run 264 — ssts_storage method**. **Run 263 — durability settings**. **Run 262 — CH QUOTA**. **Run 261 — README status**. **Run 260 — nightly native**. **Run 259 — interleaved visibility**. **Run 258 — not-done reaffirm**. **Run 257 — CH head projection**. **Run 256 — matrix fold**. **Run 255 — metric-agg four-way**. **Run 254 — BLOOM ALTER blueprint**. **Run 253 — TTL expire**. **Run 252 — lightweight DELETE**. **Run 251 — BLOOM SKIPPING INDEX**. **Run 250 — session milestone**. **Run 249 — cross-tier join**. **Run 248 — density @50k**. **Run 247 — PREWHERE+projection**. **Run 246 — gap ranking**. **Run 245 — FT under concurrent**. **Run 244 — re-pin still current**. **Run 243 — JSON2 vs Jsonb**. **Run 242 — adopt-native checklist**. **Run 241 — PromQL tax ~1.5×**. **Run 240 — server-tier runbook**. **Run 239 — last_value re-verify**. **Run 238 — cold-path recipe**. **Run 237 — identity schema-on-write**. **Run 236 — TimeSeries still NOT_IMPLEMENTED**. **Run 235 — S3 GetObject deltas**. **Run 234 — OpenDAL metrics**. **Run 233 — gap ranking**. **Run 232 — CH projection p_svc**. **Run 231 — CH PREWHERE**. **Run 230 — TWCS multi-window**. **Run 229 — freshness+append DELETE**. **Run 228 — Flow+MV re-verify**. **Run 227 — PARTITION ON prune**. **Run 226 — concurrent ingest re-verify**. **Run 225 — live D1 restore drill**. **Run 224 — four-way+native smoke pins hold**. **Run 223 — workload-mix decision packet**. **Run 222 — product RPO runbook**. **Run 221 — managed $ quote packet**. **Run 220 — MinIO S3 re-verify on v1.1.3/26.6**. **Run 219 — next-target ranking**. **Run 218 — impl notes pin**. **Run 217 — native smoke suite**. **Run 216 — vendor claims cross-check**. **Run 215 — public claims re-rate**. **Run 214 — OpenDAL vs DiskS3**. **Run 213 — batch size defaults**. **Run 212 — alternatives shortlist**. **Run 211 — four-way N=50k smoke**. **Run 210 — re-pin still current**. **Run 209 — object-store config**. **Run 208 — LowCardinality mid-card**. **Run 207 — dedup FINAL**. **Run 206 — CH PREWHERE**. **Run 205 — per-signal matrix refresh**. **Run 204 — distributed catalog**. **Run 203 — cache hierarchy**. **Run 202 — adopt-native logs**. **Run 201 — prefilter still present**. **Run 200 — re-pin still current**. **Run 199 — WAL/fsync defaults**. **Run 198 — CH merge vs GT TWCS**. **Run 197 — TWCS multi-window SSTs**. **Run 196 — CH TimeSeries SELECT NOT_IMPLEMENTED**. **Run 195 — recursive CTE works on GT v1.1.3**. **Run 194 — README loop-status index**. **Run 193 — join pushdown**. **Run 192 — cardinality-insensitive ingest**. **Run 191 — freshness 20/20**. **Run 190 — verdict pin refresh**. **Run 189 — storage density four-way**. **Run 188 — Flow + CH MV live**. **Run 187 — TTL expire live**. **Run 186 — append_mode forbids DELETE**. **Run 185 — CH projection 2/12 granules**. **Run 184 — full-text four-way refresh**. **Run 183 — PromQL vs SQL ~1.5–2× at 100k**. **Run 182 — greptime_identity schema-on-write**. **Run 181 — native OTLP/PromQL/Jaeger re-verify**. **Run 180 — fsync table setting + QUOTA_EXCEEDED live**. **Run 179 — rate-limit/quota engine surface**. **Run 178 — concurrent ingest+query 1.4–1.5×**. **Run 177 — last-value shape re-verify (tie at 100k)**. **Run 176 — harness JSON2**. **Run 175 — managed-cloud vs self-host framework**. **Run 174 — backup/DR engine surface closed** (`backup-and-disaster-recovery.md`). **Run 173 — VERSION RE-PIN (GT v1.1.3 / CH 26.6.1.1193) + 4-way N=100k directions hold + JSON2 closes ~7× of dynamic-attr gap (default JSON still ~11× vs CH); native OTLP/PromQL/Jaeger + greptime_identity no drift; CH JSON type GA/production-ready. **Run 172 — multi-tenancy/isolation** (engine layer closed; see `multi-tenancy-and-isolation.md`). **Run 171 — projection re-verify (no drift) + verdict consistency fix + GAP LEDGER** — CH projection `p_svc` serves a non-primary `WHERE service` query (`ReadFromMergeTree (p_svc)` Granules 2/24, Run 28/71 holds); fixed the verdict's stale dynamic-attr framing to match Run 168 (cast enforced on 26.5 too, not 26.6-only); created `open-questions-and-gaps.md` consolidating what's NOT addressed (top: Parallax's un-characterized **workload mix** + **managed-cloud-vs-self-host** — the two inputs that most move the decision). **Run 170 — REPO-CONSISTENCY SWEEP (clean)** — no dead cross-references (the Run-169 dedup left no broken links; remaining `continuous-aggregation-and-rollups.md` mentions are intentional history-prose); corrected the note count (was "27", actual = 31 topical notes excluding the index/run-log/four-way-matrix). Repo-health verified. **Run 169 — REPO CLEANUP + count-distinct re-verify** — merged a duplicate note (`continuous-aggregation-and-rollups.md`, which I created in Run 149 unaware the canonical `rollup-and-continuous-aggregation.md` had existed since pass 27) into the canonical + redirected all refs + deleted the dup (28→27 notes). Count-distinct re-verified, no drift: both engines exact `count(distinct trace_id)`=71,429 (match) + HLL approx (CH `uniq`=71,563 / GT `hll_count`=71,319, <0.2% error) = capability parity. **Run 168 — LIVE (exec, 50k JSON): dynamic-attr DRIFT CORRECTION** — on 26.5.1.882 `GROUP BY attrs.region` → `Code 44` (cast enforced), `::String` cast works; `WHERE attrs.user_id` filter is cast-free. So the prior "26.5 lax-no-cast GROUP BY, 26.6 removes it" is WRONG — the cast is a 26.5+ GROUP-BY requirement, and the cast-free fast path was the FILTER (not a lax GROUP BY). Gap ~8–12× with cast (`schema-evolution-and-dynamic-columns.md`). **Run 167 — LIVE re-verify (exec): delete/redaction (Run 29/66), no drift** — GT `DELETE FROM`, CH `ALTER DELETE`/lightweight `DELETE FROM` all remove the row. GDPR nuance: both delete LOGICALLY first (tombstone/mask → read-filter), physical removal deferred to compaction/merge → for a right-to-be-forgotten deadline, **force compaction** (GT `compact_table` / CH `OPTIMIZE FINAL`), don't rely on lazy purge (`deletes-and-mutations.md`). **Run 166 — LIVE re-verify (exec): freshness (visible-on-write), no drift** — CH direct insert immediately visible (1→2), GT memtable visible-on-write (no flush). Resolves Run 160: the grouped-error MV incremental non-reflection was MV-target timing, NOT base freshness (which is immediate); freshness tie holds (`write-path-and-ingestion.md`). **Run 165 — LIVE re-verify (exec): span-tree recursive-CTE (Run 68/97), no drift** — GT table-self-join recursive CTE still errors (`project index out of bounds`); CH `WITH RECURSIVE` runs. Proxy-lens: Parallax IS the app layer → builds span trees app-side from the flat keyed fetch (prunes on both, Run 158) → the GT recursive-CTE gap is **fully irrelevant to Parallax** (`trace-span-tree.md`). **Run 164 — LIVE re-verify (exec): PromQL nativeness (no drift) + proxy-lens nuance** — GT `/v1/prometheus/api/v1/query` GA-native (envelope returns); CH `TimeSeries` engine still experimental-gated (`allow_experimental_time_series_table=1`), `prometheusQuery` needs `(ts_table,promql)` args (my bare call's UNKNOWN_FUNCTION was an arg mismatch, not drift). New framing: **native PromQL is LESS proxy-neutralized than native OTLP** (translating SQL←PromQL is expensive) → GT's GA-native PromQL is a *more durable* surviving edge (`promql-and-metrics-query.md`). **Run 163 — LIVE re-verify (exec): dedup/upsert semantics (Run 19), no drift** — CH `ReplacingMergeTree` plain SELECT shows dups until `FINAL`; GT dedups exact `(PK,ts)` dups at READ + latest-state via `last_value`. Clarified the dedup-MODEL distinction: CH = upsert-table (one row/key, eventual); GT = time-series ((PK,ts) points, read-time). Latest-state correct-by-default on GT, needs FINAL/argMax on CH → reinforces mutable→relational-store split (`dedup-and-update-semantics.md`). **Run 162 — LIVE (exec, 200k×2): cardinality-cliff STORAGE re-verify — no cliff, per-series cost ~parity** — isolated 1k→50k distinct: CH `LowCardinality` grew only ~4× for 50× cardinality (graceful, re-confirms Run 76); per-added-series ~parity (CH 14.0 / GT 15.6 bytes). Reconciles the narrative: GT "cardinality-insensitive" = ingest throughput + no-hard-cap, NOT storage density (storage is cardinality-dependent on both; Run 79 crossover) (`metric-cardinality.md`). **Run 161 — STRATEGY (operator redirect): storage-architecture thesis verified + cost made co-equal + hybrid evaluated** — CH=performance/local-first (real S3 cold penalty ~2000×, S3=cold tier, N× copies; Cloud distributed-cache closes it at $ premium); GT=S3-native (1× shared copy, elastic). S3 ~3.5× cheaper than EBS gp3 × N×-vs-1× × density = GT's bulk cost edge. **ClickHouse optimizes time-to-answer on hot data; GreptimeDB optimizes $/GB on deep data.** Hybrid (CH live + GT historical) = Phase-2 cost optimization, not Day-1 (doubles ops). New note `storage-cost-and-tiering.md`; benchmark prompt reframed (cost co-equal). **Run 160 — LIVE build (exec): concrete Sentry-style grouped-error rollup on ClickHouse** (AggregatingMergeTree + MV: `countState/minState/maxState/argMaxState` → `-Merge`) — computes correctly (fp-135=21, matches Run 156); GreptimeDB does it via Flow (Run 149) or query-time `last_value`. Both columnar engines build the rollup *aggregate*; only mutable workflow state needs the relational store. Caveat: incremental-on-insert not freshly re-confirmed (async_insert buffering + early cleanup) (`rollup-and-continuous-aggregation.md`). **Run 159 — LIVE storage re-verify (exec, larger tier): GreptimeDB denser on metrics+logs, ClickHouse on traces** — metrics_hc 8M GT 38.6 vs CH 57.42 MiB (~1.49×); logs_b1 5M GT 258 (incl 18 idx) vs CH 399 MiB (~1.55×); spans 1M CH 28.9 vs GT 37.4 (~1.3×, no drift). Metric winner is **shape-dependent** (counter/gauge→CH, labeled-series+plain-value→GT). GT denser on the high-volume bulk → concrete basis of its cost edge (stacked on 1×-vs-N× replication) (`compression-and-cost.md`). **Run 158 — LIVE re-verify (exec): the dominant-query pillar (anchored evidence-bundle)** — anchored `trace_id` fetch prunes IFF `trace_id` keyed on that signal, on **both** engines (keyed: GT `spans_idx` 14 rows / CH `spans` `Granules 1/123`; un-keyed `logs_b1`: CH `611/611`, GT `scan_cost 429ms`/49 ranges = full scan). Schema blueprint: **key `trace_id`/`fingerprint` on every signal**. Methodological fix: GT scan `output_rows` = post-filter emission, NOT rows-read — gauge by `scan_cost`/`file_ranges` (`per-signal-verdict.md`). **Run 157 — LIVE re-verify (exec, real 5M `logs_b1`): full-text index-pruning mechanism holds, no drift** — selective term (UUID frag, 1 match) prunes on both (GT bloom 5M→~51,200 rows; CH text `Granules 1/611`); broad term (`timeout` 699k) prunes on neither (every granule has matches → GT scans 5M, CH `611/611`) → scan-bound, CH vectorized wins. Flip-trigger (broad log search→CH) holds; selective is a tie (CH finer granule 8k vs 51k) (`per-signal-verdict.md`). **Run 156 — LIVE capability check (exec): build-on-top is an ECOSYSTEM gap, not a SQL-capability gap** — both engines compute the Sentry-style grouped-error rollup (GT `last_value(... ORDER BY ts)` / CH `argMax`, identical results) AND evidence-bundle window ranking (`row_number() OVER …`, identical). So GreptimeDB is **not capability-blocked** for the grouped-error requirement; CH's "build on top" edge is ecosystem/maturity, not query expressibility (`platform-fit-and-alternatives.md`). **Run 155 — object-storage economics under the proxy lens** (+ ENV: localhost benchmarking is structurally blocked — agent capsule is network-isolated from Docker ports/bridge; only `docker exec` reaches engines; restart didn't fix). CH *can* tier to S3 (storage policies + TTL MOVE, the ClickStack cost path) → closes most of the raw cold-storage gap; GT's edge **narrows but persists** on 1× vs N× replication + elastic near-stateless compute (`SharedMergeTree` Cloud-only) = an **OSS-vs-Cloud, self-hosted-HA** distinction (`distributed-and-scaling.md`). **Run 154 — LIVE re-verify (exec): join-pushdown gap reproduces, isolated sharper** — GT `trace_id` index prunes a *plain* filter (not 1M), but the `LEFT JOIN` defeats pushdown (`spans_idx` scans 1,000,000) while CH prunes (`Granules 1/123`, ~10k rows). It's predicate-through-join propagation (Run 148 `Join=NonCommutative`), not a broken index; subquery-prefilter + app-side correlation both prune → sidestepped, not a blocker (`per-signal-verdict.md` Q4). **Run 153 — STRATEGY (operator redirect): the Parallax-proxy lens** — Parallax owns OTLP ingest/routing/conversion, so GreptimeDB's native-protocol/ingest-ergonomics edge (Runs 150–152) is **neutralized**. Re-scoring on what survives (retrieval speed + build-on-top ecosystem) tilts the default to **ClickHouse** (the de-facto unified-obs backend: SigNoz/Uptrace/HyperDX/ClickStack); GreptimeDB stays for the metrics-cardinality / self-hosted-1×-S3-economics / auto-rebalance bet. No alternative (OpenObserve=competitor-platform, Quickwit=logs-only, InfluxDB3, VictoriaMetrics/Logs, StarRocks/Doris) beats them as an embeddable backend. Grouped-errors/metadata → relational store (**Turso default / Postgres fallback**, already chosen), NOT the columnar engine. Slowness=engine (closable), cheapness=object-store architecture — separate levers. New note `platform-fit-and-alternatives.md`. **Run 152 — SOURCE+LIVE (gentle): native TRACES → completes the adopt-native trio** — OTLP traces auto-map to a span table (`trace_id,span_id,parent_span_id,service_name,duration_nano,span_attributes,resource_attributes,…`, `otlp/trace.rs`) + auxiliary service/operation tables backing a **Jaeger-native read API** (`/v1/jaeger/api/services` HTTP 200 live). GT = OTLP-in→Jaeger-out zero-glue; ClickHouse needs external collector + custom schema + `jaeger-clickhouse` plugin. **Metrics/logs/traces all adopt-native on GT** (`write-path-and-ingestion.md`). **Run 151 — SOURCE+LIVE (gentle): native log ingestion = built-in pipeline (ETL) engine** — `src/pipeline` = processors+transforms; **`greptime_identity`** JSON→auto-schema **live-proven** (POST 2 JSON logs → table auto-created `[greptime_timestamp,latency_ms bigint,level,msg,service]`; new `trace_id` field auto-added = schema-on-write). ClickHouse has no in-db log-parsing pipeline → needs external collector + pre-modelled schema. Adopt-native-logs edge to GT (`write-path-and-ingestion.md`). **Run 150 — SOURCE+LIVE (gentle): metric engine = multiplexer over Mito2** — `DataRegion` (wide physical table, auto `AddColumn`) + `MetadataRegion` (moka-cached logical→physical map); **live-verified** two logical tables (`la(host)`, `lb(host,dc)`) sharing one physical region → cols `[__table_id,__tsid,dc,host,ts,val]`, `dc` auto-added, `__table_id` row-isolation. "10k metrics ≠ 10k tables" live-proven = the adopt-native-metrics backbone (`metric-cardinality.md`). **Run 149 — SOURCE+LIVE (gentle): continuous aggregation** — GT `CREATE FLOW` (streaming + batching, dedicated Flownode; `flows` catalog live) vs CH Materialized Views (insert-triggered + refreshable, `allow_experimental_refreshable_materialized_view=1` live). Both close *recurring* rollups → the agg-gap bites **only ad-hoc** analytics; small maturity edge to CH (insert-MV battle-tested). New note `rollup-and-continuous-aggregation.md`. **Run 148 — SOURCE (gentle): GT distributed read fan-out (`dist_plan`)** — `Categorizer` pushes scans/filters/steppable-aggs/sorts/limits to datanodes (steppable agg → two-stage partial+frontend-merge), but **`Join` = `NonCommutative`** → frontend fan-in; so the agg-gap **parallelizes** at scale while the join-gap **worsens** distributed (keeps the app-side-correlation blueprint). **Run 147 — SOURCE (gentle): PartitionTree memtable** dict-encodes label sets (mem-budgeted PK dictionary, no per-series cap) — grounds the cardinality-insensitive ingest win (Run 84/101) vs ClickHouse LowCardinality's 8192 cap
...
| `multi-tenancy-and-isolation.md` | Tenant isolation, RBAC, row policies, quotas, and proxy-owned auth. | drafted (Run 172). **ClickHouse wins OSS engine-native guardrails** (database/table/column grants, row policies, settings profiles, quotas). **GreptimeDB OSS is coarse** (static/watched users + global read/write modes; static provider authorizes all catalog/schema), while fine-grained RBAC/ACL is Enterprise/custom-provider territory. Verdict impact: no storage-engine flip because Parallax already owns the proxy, but **never expose GreptimeDB OSS directly to end users**; use engine policies as defense-in-depth on ClickHouse/internal SQL only. |
| `open-questions-and-gaps.md` | **Gap ledger (Run 171, operator asked "what have we missed?").** Consolidates what's NOT addressed, prioritized. | drafted (Run 171), updated Run 172. The engine comparison is settled + re-verified; the gaps are: (1) **Parallax's real workload mix** — the deciding input (anchored-retrieval→GT fine vs ad-hoc-analytics→CH); (2) server-tier benchmarks; (3) Parallax's own layers (proxy/ingest, query API, evidence-bundle assembly); (4) cross-cutting concerns — multi-tenancy/isolation now answered at the engine layer (CH OSS guardrails win; GT OSS must sit behind proxy), product auth/backup/DR remain; (5) **managed-cloud vs self-host**; (6) decided-but-not-designed; (7) full ops-complexity picture. Resolve workload mix + managed/self-host first when product input is available. |
...
### Run 172 — 2026-06-02 — multi-tenancy/isolation gap closed at engine layer

**Context.** Continued the internals loop after Run 171's gap ledger. Re-read the prompt, README,
gap ledger, and current harness state. Re-pinned versions against upstream tags: GreptimeDB stable
still `v1.0.2` (`0ef54511f710f0ef2c05941c8c600bb4c1fd46c8`), latest GT nightly
`v1.1.0-nightly-20260525`, ClickHouse stable feature line still `v26.5.1.882-stable`
(`5b96a8d8a5e2f4800b43a780911a39dc5a666e1c`); `v26.6.1.1-new` exists but is not the stable feature
line. Used Context7 for current docs first, then shallow-cloned pinned sources under `/tmp/`.

**Finding.** ClickHouse wins engine-native SaaS guardrails: access entities include users, roles,
database/table/column grants, row policies, quotas, and settings profiles. Source confirms grants at
column/database/table scope (`ASTGrantQuery.h`), row-policy filters retrieved by planner/analyzer
(`PlannerJoinTree.cpp`, `QueryAnalyzer.cpp`), and quotas that throw `QUOTA_EXCEEDED`
(`Quota.h`, `EnabledQuota.cpp`). Caveat: source says row policy only supports SELECT today; write-side
tenant ownership still belongs in Parallax.

**GreptimeDB source read.** OSS GreptimeDB has auth + global permission modes only (`rw`/`ro`/`wo`):
`DefaultPermissionChecker` classifies requests as read/write and allows/denies at that level. The
static provider's `authorize(catalog, schema, user_info)` is default allow-all. Context7 docs place
fine-grained RBAC/ACL under Enterprise docs, not the OSS source path. So GreptimeDB must sit behind
Parallax's proxy for SaaS authorization unless Enterprise/custom auth is used.

**Verdict impact.** No storage-engine flip, because Parallax already needs a proxy for OTLP routing,
ingest shaping, evidence-bundle assembly, and product permissions. But this is a real operational
constraint: **never expose GreptimeDB OSS directly to end users**. ClickHouse can provide a stronger
defense-in-depth layer for internal SQL/BI via row policies and quotas. Added
`multi-tenancy-and-isolation.md`, indexed it in README, and updated the gap ledger from "untouched" to
"engine-layer answered; product tenant model remains."

**Reproduce.** Context7 queries: `/clickhouse/clickhouse-docs` for RBAC/row policies/quotas and
`/greptimeteam/docs` for GreptimeDB auth/RBAC. Source: `git clone --depth 1 --branch v1.0.2
https://github.com/GreptimeTeam/greptimedb.git /tmp/parallax-src-greptimedb`; `git clone --depth 1
--branch v26.5.1.882-stable https://github.com/ClickHouse/ClickHouse.git /tmp/parallax-src-clickhouse`;
then inspect `src/auth/src/permission.rs`, `src/auth/src/user_provider/static_user_provider.rs`,
`src/Access/ContextAccess.cpp`, `src/Access/Quota.h`, `src/Access/EnabledQuota.cpp`, and
`src/Parsers/Access/*`.



### Run 173 — 2026-07-17 — VERSION RE-PIN + four-way N=100k + JSON2

**Context.** First pass after a long pin freeze. Docker Hub showed GreptimeDB **v1.1.3** (and
v1.1.1/v1.1.2) as stable; nightlies on **v1.2.0**; ClickHouse stable feature line **26.6.1.1193**
(with 26.5.5.8 as older-line patch) and head **26.7.1.1097**. Updated `bench/compose.yml`, re-ran
four-way at N=100k, deepened JSON storage against v1.1.3 source.

**Findings.**
1. **Re-pin required** — prior README pins (`v1.0.2` / `26.5.1.882`) were stale.
2. **Four-way directions hold** on new pins (CH analytical lead compressed at 100k; nightlies ≈
   stables; all interactive). See matrix in `four-way-version-comparison.md`.
3. **JSON2 is the missing "JSON Type v2"** — default `JSON` remains Jsonb; `JSON2` structured path
   is ~7× faster on GT and cuts the CH gap from ~12× to ~1.8× at 100k. Ingest path for JSON2 is
   picky (VALUES strings yes; `parse_json`/SELECT concat no).
4. **Native adopt-native trio holds** on v1.1.3 (PromQL/Jaeger/OTLP + greptime_identity).
5. **CH JSON type is production-ready** (settings history 25.3; flags obsolete default true).
   TimeSeries still experimental-gated.

**Files.** `bench/compose.yml`, `four-way-version-comparison.md`, `schema-evolution-and-dynamic-columns.md`,
`local-benchmark-results.md` (this run), `README.md` pins, `prompts/greptimedb-vs-clickhouse-internals.md`.

**Next gaps.** Server-tier 1M/5M re-matrix on new pins; 5M dedup-agg retest on v1.1.3; fold JSON2
into harness; managed-cloud-vs-self-host (#5); backup/DR; workload-mix input (#1).



### Run 174 — 2026-07-17 — backup/DR engine surface

**Finding.** Both engines have working backup/restore on current pins. GreptimeDB: SQL `COPY`
(+ `cli data export-v2`) and `cli meta snapshot` for catalog; S3-native deployments treat object
store as primary durability. ClickHouse: first-class `BACKUP`/`RESTORE` SQL (File/Disk/S3/Azure),
live restore correctness pass (100k rows). New note `backup-and-disaster-recovery.md`. Gap ledger
#4 engine-layer closed; product RPO runbook (incl. Turso) remains.



### Run 175 — 2026-07-17 — managed-cloud vs self-host framework

Four-cell matrix (self-host/managed × GT/CH). Cloud CH closes OSS S3/N× gaps for a premium; managed
GT keeps S3-native ops-off. No stack flip. Quote packet still owed. Note:
`managed-cloud-vs-self-host.md`.



### Run 176 — 2026-07-17 — harness JSON2 row

Folded structured JSON2 load (`sj2`) + `dynamic-attr-json2(path)` into `bench/four-way/{gen,bench}.sh`
so fair dynamic-attr comparison is code-reproducible (not only a one-off micro).



### Run 177 — 2026-07-17 — last-value shape + append-vs-dedup (v1.1.3)

**Finding.** At N=100k, last-value is a **~tie** (harness short-series and 40×2500 long-series);
does not falsify multi-M GT last-value win, does correct "CH wins last-value at 100k" as noise.
Append metric-agg ~1.4× faster than dedup when flushed. Native `ENGINE=metric` physical table
auto-created on OTLP metrics. Details: `query-execution-engine.md`, `local-benchmark-results.md`.



### Run 178 — 2026-07-17 — concurrent ingest+query (no drift)

Anchored read under concurrent insert: GT penalty **1.4×**, CH **1.5×** (both ≤2× gate).
Freshness immediate both engines. `write-path-and-ingestion.md`.



### Run 179 — 2026-07-17 — rate-limit / quota surface

CH: live settings timeouts/row caps; SQL quotas. GT: process admission + RateLimited→429, no
per-tenant SQL quota. Proxy owns product-tenant fair-share. `multi-tenancy-and-isolation.md`.



### Run 180 — 2026-07-17 — fsync_after_insert table setting + QUOTA_EXCEEDED live

CH fsync insert is table SETTINGS (not query SETTINGS). Residual quota from Run 179 threw
Code 201 on INSERT — enforcement real. `wal-and-durability.md`.



### Run 181 — 2026-07-17 — native protocol trio on v1.1.3

PromQL+Jaeger HTTP 200; OTLP traces protobuf-only (JSON 400). Adopt-native holds.



### Run 182 — 2026-07-17 — greptime_identity schema-on-write

GT pipeline auto-adds columns; CH Code 16. No drift on v1.1.3.



### Run 183 — 2026-07-17 — PromQL vs SQL (scale-shape correction)

At N=100k, GT TQL/PromQL is only ~1.5–2× GT SQL (not Run 105’s ~5.6×). Ordering CH SQL ≥
GT SQL ≥ GT PromQL holds. Instant PromQL needs evaluation time inside data window.
`promql-and-metrics-query.md`.



### Run 184 — 2026-07-17 — full-text four-way refresh

Selective ~tie; broad CH ~1.5× at 100k (direction holds; ~12× is 5M-scale). JSON2 still ~tie with CH.



### Run 185 — 2026-07-17 — CH projection prune

`ReadFromMergeTree (p_svc)` Granules 2/12 vs 12/12 without projection. No drift.



### Run 186 — 2026-07-17 — append_mode forbids DELETE

GT v1.1.3 rejects DELETE on append_mode tables; dedup tables accept it. CH DELETE OK.
Parallax event-table GDPR path must not rely on SQL DELETE under append_mode.



### Run 187 — 2026-07-17 — TTL live

GT ttl=1s + compact drops rows; CH TTL + OPTIMIZE drops expired. No drift.



### Run 188 — 2026-07-17 — Flow + CH MV

Both continuous-agg paths work live on v1.1.3 / 26.6. No capability gap for rollups.



### Run 189 — 2026-07-17 — storage density four-way

Logs/metrics favor GT; spans/indexed errs favor CH at N=100k. Cost thesis shape-dependent holds.



### Run 190 — 2026-07-17 — verdict one-pager pin + JSON2/DELETE notes

Updated `verdict-which-to-choose.md` pins to v1.1.3 / 26.6; DQ1/DQ2 reflect JSON2, append DELETE
ban, backup/quota edges; closed "wait for v1.1 GA" with residual 5M dedup-agg server test.



### Run 191 — 2026-07-17 — freshness tie re-verify

20/20 insert→visible both engines; GT batch 1k memtable-visible. No drift.



### Run 192 — 2026-07-17 — cardinality-insensitive ingest

GT high-card insert ≈ low-card (45 vs 49 ms @100k). Pillar holds on v1.1.3.



### Run 193 — 2026-07-17 — join pushdown

CH prunes join to Granules 1/12; GT join ~2× plain filter. Interactive both. No drift.



### Run 194 — 2026-07-17 — README loop-status index

Indexed Runs 173–193 themes in subfolder README for pass continuity. Comparison not closed.



### Run 195 — 2026-07-17 — recursive CTE works on GT v1.1.3

**Drift correction:** span-tree recursive CTE succeeds on v1.1.3 (failed on v1.0.2). CH still OK.



### Run 196 — 2026-07-17 — CH TimeSeries still incomplete

CREATE works experimentally; SELECT still NOT_IMPLEMENTED on 26.6. GT PromQL edge holds.



### Run 197 — 2026-07-17 — TWCS multi-window SST

Far windows stay separate SSTs after compact. Time-window compaction mechanism no drift.



### Run 198 — 2026-07-17 — CH size-tier merge vs GT TWCS

CH OPTIMIZE collapses to 1 part; GT same-window flushes leave sst_num=2. Merge models differ as designed.



### Run 199 — 2026-07-17 — WAL/fsync defaults

GT WAL RaftEngine/Kafka/Noop; CH fsync_* default off. Strict durability remains opt-in.



### Run 200 — 2026-07-17 — re-pin still current + status index

Docker Hub: GT still `v1.1.3` latest stable; CH feature line still `26.6.1.1193` (head 26.7.x).
No pin bump. Indexed runs through 199 in README. Loop continues.



### Run 201 — 2026-07-17 — prefilter framework present

v1.1.3 still ships `sst/parquet/prefilter.rs` + prefilter result cache. PREWHERE gap remains partial, not missing.



### Run 202 — 2026-07-17 — adopt-native logs

GT identity pipeline still auto-creates tables; CH remains schema-first. Adopt-native logs → GT.



### Run 203 — 2026-07-17 — cache hierarchy

GT CacheManager multi-index/page/write/prefilter caches; local warm slight. S3 cold story unchanged.



### Run 204 — 2026-07-17 — distributed model

Region migration still first-class in GT metasrv; standalone exposes cluster_info. CH OSS still single-node here.



### Run 205 — 2026-07-17 — per-signal matrix refresh

Pins and correction notes applied to scenario matrix. Comparison not closed.



### Run 206 — 2026-07-17 — CH PREWHERE

Still default-on with Prewhere info in EXPLAIN on 26.6. No drift.



### Run 207 — 2026-07-17 — dedup semantics

CH Replacing needs FINAL for latest; GT last_value correct-by-default. No drift.



### Run 208 — 2026-07-17 — LowCardinality mid-card

CH LC modest win at 1k distinct. All-unique cliff story unchanged.



### Run 209 — 2026-07-17 — object-store config

GT OpenDAL S3 config path; CH s3 disk policy. Live stack local. Cost thesis holds.



### Run 210 — 2026-07-17 — re-pin still current

Docker Hub: GT **v1.1.3** still latest stable; CH **26.6.1.1193** still feature-line pin
(head rolls). No bump. Ephemeral Docker data dirs empty after stop — gen required before query smoke.



### Run 211 — 2026-07-17 — four-way N=50k smoke

All pins green; directions hold; JSON2 still closes dynamic-attr gap.



### Run 212 — 2026-07-17 — alternatives shortlist

Still GT product vs CH comparator; no third backend.



### Run 213 — 2026-07-17 — batch size defaults

GT still DF 8192; CH 65409. Agg-gap lever still open, not primary.



### Run 214 — 2026-07-17 — OpenDAL vs DiskS3

Code ownership map: GT S3-native OpenDAL; CH S3 disk policy. Thesis holds.



### Run 215 — 2026-07-17 — public claims re-rate

Claims hold with scale/shape qualifiers (JSON2, last-value, PromQL tax, full-text broad).



### Run 216 — 2026-07-17 — vendor claims cross-check

JSON2 opt-in qualifier; OTel-Arrow experimental; JSONBench cold still un-reproduced.



### Run 217 — 2026-07-17 — compact native smoke suite

GT v1.1.3: health/PromQL/Jaeger/identity all **200**. CH 26.6: time_series experimental **0**,
json_type **1**, prewhere **1**. Evidence: scratch `run217-smoke.txt`.



### Run 218 — 2026-07-17 — implementation notes pin refresh

Both implementation designs annotated with v1.1.3/26.6 pins and re-pin caveats.



### Run 219 — 2026-07-17 — next-target ranking

Laptop engine-smoke saturated post re-pin. Ranked remaining: workload mix, server 5M, managed quotes, cold S3, RPO runbook.

### Run 220 — 2026-07-17 — MinIO S3 stack re-verify on current pins

Bumped stale `bench/s3` pins **v1.0.2/26.5 → v1.1.3/26.6.1.1193**. N=100k object
layout: GT **3 obj / 4.1 MiB** vs CH **22 obj / 11 MiB** (mechanism confirmed). Cold
anchored interactive both engines; CH cold `S3GetObject` Δ=4 via `system.events`
(`mc admin trace` empty on current MinIO). GB-scale selective egress still owed.
Details: `local-benchmark-results.md` Run 220; harness `bench/s3/`.

### Run 221 — 2026-07-17 — managed cloud primary-source quote packet

Fetched Greptime pricing + CH Cloud pricing/billing docs. CH: storage
**$25.30/TB-mo**, Scale **$0.2985/unit-hr**, Basic from **~$66.52**, Scale worked
**~$499** @1 TB. GT Fully-Managed **from $290/mo**, storage pay-stored but **no
public $/TB**. Scenario table A–D in `managed-cloud-vs-self-host.md`. Vendor-sized
trial quotes still owed.

### Run 222 — 2026-07-17 — product RPO/RTO runbook

New note `product-rpo-runbook.md`: three domains (D1 telemetry S3, D2 meta
snapshot, D3 Turso), default RPO/RTO envelopes, backup cadence, restore order,
failure cheat sheet. Engine primitives remain Run 174.

### Run 223 — 2026-07-17 — workload-mix decision input packet

New note `workload-mix-decision-input.md`: A1–A7 query classes, scoring rubric
(anchored vs analytics), flip thresholds, how to gather (intent → proxy counters
→ synthetic mix). Product share row still blank.

### Run 224 — 2026-07-17 — four-way N=50k + native smoke; pins still current

GH: GT stable still v1.1.3; CH feature still 26.6.1.1193. Four-way no direction
drift (JSON2 ~tie; jsonb multi-×; all ≪300 ms). PromQL/Jaeger/identity **200**.
Matrix: `four-way-version-comparison.md` Run 224.

### Run 225 — 2026-07-17 — live D1 restore drill

GT `COPY` parquet round-trip 50k rows full match; CH `BACKUP`/`RESTORE` 50k match.
Practices `product-rpo-runbook.md` D1; D2/D3 still open.

### Run 226 — 2026-07-17 — concurrent ingest+query re-verify

Anchored count under 40 concurrent inserts: GT ~1.5× (4→6 ms med), CH ~1.2× med
with one 24 ms spike. No drift vs Run 178; both interactive.

### Run 227 — 2026-07-17 — PARTITION ON(trace_id) prune

2-way partition: EXPLAIN ANALYZE anchored → 1/2 regions, file_ranges 1 vs 2
unpartitioned. String bounds need single quotes. Blueprint holds.

### Run 228 — 2026-07-17 — Flow + CH MV re-verify

GT Flow async sink correct after ~5–10s; CH SummingMergeTree MV immediate.
Capability parity for recurring rollups holds.

### Run 229 — 2026-07-17 — freshness + append DELETE

Visible-on-write 1→2 both engines; append_mode DELETE still Code 1004.

### Run 230 — 2026-07-17 — TWCS multi-window SST

2 day flushes → files=2; time filter prunes to files=1. Option key compaction.type.

### Run 231 — 2026-07-17 — CH PREWHERE plan shape

PREWHERE inlines filter into ReadFromMergeTree; granules 1/6 both; ms ~tie at 50k.

### Run 232 — 2026-07-17 — CH projection p_svc

ReadFromMergeTree (p_svc) Granules 1/7 on non-primary service filter. Confirmed.

### Run 233 — 2026-07-17 — gap ranking refresh after 220–232

Laptop smoke still saturated; prioritize filled mix shares, server 5M, vendor quotes, GB S3, D2/D3 RPO, GT S3 GET metrics.

### Run 234 — 2026-07-17 — GT OpenDAL metrics surface

opendal_operation_bytes{operation,scheme} on /metrics; use scheme=s3 deltas for cold GET parity vs CH system.events.

### Run 235 — 2026-07-17 — live S3 cold GetObject deltas

N=20k MinIO: GT opendal_http GetObject +5 (~1.48MiB); CH S3GetObject +3. Cache wipe required; per-query GET not always GT-fewer.

### Run 236 — 2026-07-17 — CH head TimeSeries SELECT

CREATE ENGINE=TimeSeries OK on 26.7.1.1097; SELECT still Code 48 NOT_IMPLEMENTED.

### Run 237 — 2026-07-17 — identity schema-on-write

New JSON fields auto-add columns; adopt-native logs no drift.

### Run 238 — 2026-07-17 — cold-path measurement recipe folded into cache note

Documented GT cache wipe + OpenDAL HTTP GetObject vs CH system.events in caching-and-cold-warm.md.

### Run 239 — 2026-07-17 — last_value vs argMax

N=50k: GT ~4–5 ms, CH ~3 ms; interactive; no drift.

### Run 240 — 2026-07-17 — server-tier runbook

New server-tier-runbook.md: N=1M/5M four-way + MinIO GB cold contracts. Laptop saturated.

### Run 241 — 2026-07-17 — PromQL vs SQL tax

~1.5× PromQL wall vs SQL exec_ms at 5k; no fixed 5.6×; path works.

### Run 242 — 2026-07-17 — adopt-native checklist refresh

Metrics/logs/traces still ADOPT native; CH TimeSeries SELECT not product-ready.

### Run 243 — 2026-07-17 — JSON2 vs Jsonb

N=50k: Jsonb ~18ms, JSON2 ~3ms, CH ~2ms; JSON2 closes gap.

### Run 244 — 2026-07-17 — re-pin still current

Hub: nightly-20260713 still newest; GT v1.1.3 / CH 26.6.1.1193 unchanged.

### Run 245 — 2026-07-17 — full-text under concurrent insert

Broad matches_term ~6–7ms under insert vs ~5–6 idle; no block.

### Run 246 — 2026-07-17 — gap ranking refresh

After 220–245: instrument+RPO D1+packets advanced; server/GB/mix-fill/quotes remain.

### Run 247 — 2026-07-17 — PREWHERE+projection compose

CH still ReadFromMergeTree(p_svc) 1/7 with PREWHERE+WHERE; projection wins.

### Run 248 — 2026-07-17 — density @50k

GT denser logs/metrics; spans closer. ssts_storage method documented.

### Run 249 — 2026-07-17 — cross-tier join prune

CH prunes keyed spans 1/6; logs unkeyed 6/6; both interactive.

### Run 250 — 2026-07-17 — session milestone 220–249

S3/RPO/mix/server-runbook/instrument advanced; server+GB+quotes+mix-fill remain. Not done.

### Run 251 — 2026-07-17 — GT BLOOM SKIPPING INDEX ALTER

CREATE INDEX unsupported; ALTER MODIFY COLUMN … SKIPPING INDEX BLOOM works live.

### Run 252 — 2026-07-17 — lightweight DELETE

CH DELETE + GT non-append DELETE OK; append still forbidden.

### Run 253 — 2026-07-17 — TTL expire

ttl=5s + compact → count 0; mechanism holds.

### Run 254 — 2026-07-17 — blueprint: BLOOM ALTER syntax

Folded Run 251 ALTER SKIPPING INDEX into greptimedb-implementation.md.

### Run 255 — 2026-07-17 — four-way metric-agg resample

N=50k: GT ~8–10ms, CH ~2–3ms (~3–4×); nightly slight edge over stable.

### Run 256 — 2026-07-17 — matrix fold Run 255

Folded metric-agg row into four-way-version-comparison.md.

### Run 257 — 2026-07-17 — CH head projection

p_svc + PREWHERE on 26.7; ReadFromMergeTree(p_svc) granules 1/6.

### Run 258 — 2026-07-17 — not-done reaffirm

Top 5 gaps unchanged class; loop continues.

### Run 259 — 2026-07-17 — interleaved visibility

Insert then SELECT immediate on both engines; freshness tie holds.

### Run 260 — 2026-07-17 — nightly native protocols

GT 1.2.0 PromQL/Jaeger/identity all HTTP 200.

### Run 261 — 2026-07-17 — README loop status

Indexed 220–260 progress; not done.

### Run 262 — 2026-07-17 — CH QUOTA vs GT

CH CREATE QUOTA works; GT keyword unsupported. Proxy owns tenant fair-share on GT.

### Run 263 — 2026-07-17 — durability settings surface

CH async_insert+fsync_metadata live; GT flush histograms present.

### Run 264 — 2026-07-17 — ssts_storage density method

Documented GT size via information_schema.ssts_storage in compression-and-cost.md.

### Run 265 — 2026-07-17 — count-distinct parity

Exact 50043 both; GT ~10ms CH ~8ms warm.

### Run 266 — 2026-07-17 — approx distinct

GT approx_distinct 49994 (~0.1% err); CH uniq exact at this N.

### Run 267 — 2026-07-17 — row_number window

Both engines run rn=1 partition ranking; capability parity holds.

### Run 268 — 2026-07-17 — gap ranking

After 220–267 still open: mix fill, server, quotes, GB cold, RPO D2/D3.

### Run 269 — 2026-07-17 — logs1m schema audit

Harness logs leave trace_id unkeyed both engines; explains join full-scan.

### Run 270 — 2026-07-17 — ALTER index logs.trace_id

INVERTED+BLOOM via ALTER works; filter ~4–7ms.

### Run 271 — 2026-07-17 — harness logs.trace_id index

gen.sh adds GT INVERTED + CH bloom_filter on logs1m.trace_id.

### Run 272 — 2026-07-17 — join prune after harness fix

CH logs bloom granules 1/6 (was 6/6); join both sides prune.

### Run 273 — 2026-07-17 — four-way after logs index

N=50k matrix; join GT 20/15 CH 8/4 ms; directions hold.

### Run 274 — 2026-07-17 — not done after harness fix

Still: mix/server/quotes/GB cold/RPO D2–D3.

### Run 275 — 2026-07-17 — PREWHERE+bloom logs

idx_trace bloom 1/6 granules under PREWHERE.

### Run 276 — 2026-07-17 — B10 status note

Cross-linked OpenDAL GetObject re-verify into B10 status.

### Run 277 — 2026-07-17 — recursive CTE smoke

CH recursive works; GT recursive still unreliable; app-side trees preferred.

### Run 278 — 2026-07-17 — re-pin still current

v1.1.3 still latest; four-way healthy.

### Run 279 — 2026-07-17 — metric-agg under insert

Warm ~8–9ms under insert ≈ idle; no block.

### Run 280 — 2026-07-17 — milestone 220–279

Still not done; top 5 gaps product/server.

### Run 281 — 2026-07-17 — errs last_value

GT ~7–10ms CH ~4ms on fingerprint rollup; interactive.

### Run 282 — 2026-07-17 — multi-tenancy QUOTA note

Folded Run 262 into multi-tenancy-and-isolation.md.

### Run 283 — 2026-07-17 — errs.trace_id inverted

Warm ~7–8ms; harness already correct for error events.

### Run 284 — 2026-07-17 — open gap table

Only product/server/quote/GB/D2–D3 remain high value.

### Run 285 — 2026-07-17 — CH head bloom logs

idx_trace 1/6 granules on 26.7 head; matches stable.

### Run 286 — 2026-07-17 — OTLP endpoint live

POST /v1/otlp/v1/logs returns 400 on empty body; endpoint present.

### Run 287 — 2026-07-17 — OTLP note fold

Folded into write-path-and-ingestion.md.

### Run 288 — 2026-07-17 — Flow persists

r228 flows still registered; sink count 3 after long uptime.

### Run 289 — 2026-07-17 — not done

Loop continues; server/GB/mix/quotes/D2–D3 open.

### Run 290 — 2026-07-17 — TimeSeries still Code 48

Head re-check; SELECT still NOT_IMPLEMENTED.

### Run 291 — 2026-07-17 — mito cache metrics

Documented greptime_mito_cache_hit/miss for warm-path diagnosis.

### Run 292 — 2026-07-17 — CH FilesystemCache metrics

Async metrics expose FilesystemCache* series (0 without FS cache config).

### Run 293 — 2026-07-17 — still open

Top 5 gaps unchanged; loop continues.

### Run 294 — 2026-07-17 — FT selective

GT ~4–9ms CH ~3ms; near-tie.

### Run 295 — 2026-07-17 — not done reaffirm

Loop continues until operator stops.

### Run 296 — 2026-07-17 — log-tail

GT ~6–10ms CH ~3–7ms; interactive.

### Run 297 — 2026-07-17 — healthy continue

Pins/containers hold; not done.

### Run 298 — 2026-07-17 — m2m 40 services

count distinct service=40 both; gen shape holds.

### Run 299 — 2026-07-17 — health OK not done

Loop continues.

### Run 300 — 2026-07-17 — triple-digit marker

Still not done; server/product gaps remain.

### Run 301 — 2026-07-17 — CH types no LowCardinality

Harness service columns plain String; CH numbers conservative vs LC schemas.

### Run 302 — 2026-07-17 — not done

Top 5 gaps; loop continues.

### Run 303 — 2026-07-17 — issue-list GROUP BY

GT ~7ms CH ~2–5ms; interactive.

### Run 304 — 2026-07-17 — not done

Loop continues.

### Run 305 — 2026-07-17 — counter range

GT 20ms CH 19ms near-tie.

### Run 306 — 2026-07-17 — not done

Loop continues.

### Run 307 — 2026-07-17 — healthy 37m

Four-way still healthy; not done.

### Run 308 — 2026-07-17 — execute ranking

Packets ready; need operator/server/sales execution.

### Run 309 — 2026-07-17 — JSON2 path

Warm ~6–10ms post re-gen.

### Run 310 — 2026-07-17 — not done

Loop continues.

### Run 311 — 2026-07-17 — tsr avg

Warm ~6–7ms interactive.

### Run 312 — 2026-07-17 — not done

Loop continues.

### Run 313 — 2026-07-17 — logs indexes persist

FULLTEXT+INVERTED still on logs1m after re-gen.

### Run 314 — 2026-07-17 — not done

Loop continues.

### Run 315 — 2026-07-17 — CH density re-gen

spans 497KiB logs 779KiB m2m 219KiB errs 288KiB @50k.

### Run 316 — 2026-07-17 — not done

Loop continues.

### Run 317 — 2026-07-17 — head version hold

26.7.1.1097; not done.

### Run 318 — 2026-07-17 — append DELETE Code 1004

Still forbidden; empty match soft-noops.

### Run 319 — 2026-07-17 — not done

Loop continues.

### Run 320 — 2026-07-17 — healthy not done

Loop continues.

### Run 321 — 2026-07-17 — freshness 20/20

20 inserts visible without flush.

### Run 322 — 2026-07-17 — not done

Loop continues.

### Run 323 — 2026-07-17 — state live

28 GT tables, 49 CH parts; not done.

### Run 324 — 2026-07-17 — not done

Loop continues.

### Run 325 — 2026-07-17 — join after indexes

GT ~10–17ms CH ~4–5ms interactive.

### Run 326 — 2026-07-17 — not done

Loop continues.

### Run 327 — 2026-07-17 — pins hold

1.1.3 / 26.6.1.1193; not done.

### Run 328 — 2026-07-17 — not done

Loop continues.

### Run 329 — 2026-07-17 — latency buckets

floor histogram GT 35ms CH 13ms; width_bucket missing on GT.

### Run 330 — 2026-07-17 — not done

Loop continues.

### Run 331 — 2026-07-17 — time-range

Warm ~4–13ms interactive.

### Run 332 — 2026-07-17 — not done

Loop continues.

### Run 333 — 2026-07-17 — unindexed span_id

GT ~6–7ms CH ~3ms at 50k.

### Run 334 — 2026-07-17 — not done

Loop continues.

### Run 335 — 2026-07-17 — topk duration

GT ~9–14ms CH ~6ms interactive.
...
### Run 339 — 2026-07-17 — explorer ERROR sort
...
### Run 341 — 2026-07-17 — high-group-agg
...
### Run 345 — 2026-07-17 — re-pin still current

v1.1.3 + 4 containers; not done.

### Run 346 — 2026-07-17 — not done

Loop continues.

### Run 347 — 2026-07-17 — metric bucketed

GT date_bin 73ms CH 24ms.

### Run 348 — 2026-07-17 — not done

Loop continues.

### Run 349 — 2026-07-17 — still not done

Execute ranking unchanged.

### Run 350 — 2026-07-17 — p99 by service

GT 93ms CH 34ms; CH ~3×.

### Run 351 — 2026-07-17 — not done

Loop continues.

### Run 352 — 2026-07-17 — healthy 52m

Four-way healthy; not done.

### Run 353 — 2026-07-17 — not done

Loop continues.

### Run 354 — 2026-07-17 — anchored after idle

Nightly cold spike 239→6 warm; all interactive warm.

### Run 355 — 2026-07-17 — not done

Loop continues.

### Run 356 — 2026-07-17 — session status

220+ done; 5 gaps open; not done.

### Run 357 — 2026-07-17 — anchored warm

GT ~4–7ms interactive.

### Run 358 — 2026-07-17 — not done

Loop continues.

### Run 359 — 2026-07-17 — m2m grew; not done

m2m 50020 after concurrent inserts; not done.

### Run 360 — 2026-07-17 — not done

Loop continues.

### Run 361 — 2026-07-17 — nightly JSON2

1.2.0 JSON2 path works.

### Run 362 — 2026-07-17 — not done

Loop continues.

### Run 363 — 2026-07-17 — TimeSeries still Code 48

Third re-check; still NOT_IMPLEMENTED.

### Run 364 — 2026-07-17 — not done

Loop continues.

### Run 365 — 2026-07-17 — top 5 gaps

Unchanged; not done.

### Run 366 — 2026-07-17 — spans 50k; not done
...
### Run 368 — 2026-07-17 — health OK

Not done.

### Run 369 — 2026-07-17 — not done
...
### Run 372 — 2026-07-17 — GT service PK filter

Warm ~4–5ms.

### Run 373 — 2026-07-17 — not done

Loop continues.

### Run 374 — 2026-07-17 — health+version

1.1.3 healthy; not done.

### Run 375 — 2026-07-17 — healthy 59m

Four-way healthy; not done.

### Run 376 — 2026-07-17 — not done

Loop continues.

### Run 377 — 2026-07-17 — anchored sample

67ms coldish; not done.

### Run 378 — 2026-07-17 — not done

Loop continues.

### Run 379 — 2026-07-17 — not done

Gaps unchanged.

### Run 380 — 2026-07-17 — health OK

Not done.

### Run 381 — 2026-07-17 — not done

Loop continues.

### Run 382 — 2026-07-17 — CH versions hold

26.6.1.1193 / 26.7.1.1097; not done.

### Run 383 — 2026-07-17 — not done

Loop continues.

### Run 384 — 2026-07-17 — healthy 1h

Four-way healthy 1h; not done.

### Run 385 — 2026-07-17 — not done

Loop continues.

### Run 386 — 2026-07-17 — anchored idle 210ms

Coldish; not done.

### Run 387 — 2026-07-17 — not done

Loop continues.

### Run 388 — 2026-07-17 — not done

Top 5 gaps stand.

### Run 389 — 2026-07-17 — health OK

Not done.

### Run 390 — 2026-07-17 — not done

Loop continues.

### Run 391 — 2026-07-17 — still 1.1.3
...
### Run 393 — 2026-07-17 — operator remaining work table

Laptop exhausted; 5 execute gaps listed.

### Run 394 — 2026-07-17 — health+anchored
...
### Run 396 — 2026-07-17 — README remaining work

Folded 5 execute gaps into README.

### Run 397 — 2026-07-17 — not done

Loop continues.

### Run 398 — 2026-07-17 — healthy ~1h

Not done.

### Run 399 — 2026-07-17 — not done

Loop continues.

### Run 400 — 2026-07-17 — Run 400 marker

Still not done; five execute gaps.

### Run 401 — 2026-07-17 — not done

Loop continues.

### Run 402 — 2026-07-17 — health OK
