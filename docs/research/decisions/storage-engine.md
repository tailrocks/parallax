...
- **Version re-pin 2026-07-18 pass 248 (API only — no bench):**
  - GreptimeDB Latest release still **`v1.1.3`** (2026-07-17); latest named nightly release tag still
    **`v1.2.0-nightly-20260706`** (2026-07-06).
  - ClickHouse: highest feature-line stable still **`v26.6.1.1193-stable`** (2026-06-25). Newer
    **`v26.5.5.8-stable`** (2026-07-01) is **26.5 maintenance**, not a newer feature line — keep
    **26.6.x** per four-way rule. LTS line continues (e.g. `v25.8.28.1-lts`) — **not** the pin.
...
- **Version re-pin 2026-07-18 pass 266 (API only — no bench):** identical pins to pass 248 —
  ...
  **unproven**.
- **Version re-pin 2026-07-18 pass 280 (API only — no bench):** GreptimeDB Latest still **`v1.1.3`**;
  nightly still **`v1.2.0-nightly-20260706`**. Traces still **experimental**. Size/cost **unproven**.
- **Version re-pin 2026-07-18 pass 289 (API only — no bench):** GreptimeDB Latest still **`v1.1.3`**;
  nightly still **`v1.2.0-nightly-20260706`**. Traces still **experimental**. Size/cost **unproven**.
...
- **Version re-pin 2026-07-18 pass 302 (API only — no bench):** GreptimeDB Latest still **`v1.1.3`**;
  nightly still **`v1.2.0-nightly-20260706`**. Traces still **experimental**. Size/cost **unproven**.
- **Version re-pin 2026-07-18 pass 312 (API only — no bench):** GreptimeDB Latest still **`v1.1.3`**
  (2026-07-17); latest *named* nightly release tag still **`v1.2.0-nightly-20260706`**. ClickHouse
  **feature-line** tip still **`v26.6.1.1193-stable`** (do not treat **26.5.x** maintenance as feature tip).
  [Traces overview](https://docs.greptime.com/user-guide/traces/overview/) still **experimental stage**.
  Size/cost still **unproven** (no server-tier measurement this pass).
- **Version re-pin 2026-07-18 pass 322 (API only — no bench):** GreptimeDB Latest still **`v1.1.3`**;
  nightly still **`v1.2.0-nightly-20260706`**. Size/cost **unproven**.- **Version re-pin 2026-07-18 pass 326 (API only — no bench):** GreptimeDB Latest still **`v1.1.3`**. Size/cost **unproven**.
- **Version re-pin 2026-07-18 pass 333 (API only — no bench):** GreptimeDB Latest still **`v1.1.3`**. Size/cost **unproven**.
- **Version re-pin 2026-07-18 pass 341 (API only — no bench):** GreptimeDB Latest still **`v1.1.3`**. Size/cost **unproven**.
