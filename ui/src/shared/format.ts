...
function cachedDateTimeFormat(options: Intl.DateTimeFormatOptions): Intl.DateTimeFormat {
...
export function formatLogBodyPreview(body: string, max = LOG_BODY_PREVIEW_MAX): string {
