...
export type DashboardsListQueryVariables = Exact<{ [key: string]: never }>
...
export const DashboardsListDocument = {
  kind: "Document",
  definitions: [
    {
      kind: "OperationDefinition",
      operation: "query",
      name: { kind: "Name", value: "DashboardsList" },
      selectionSet: {
        kind: "SelectionSet",
        selections: [
          {
...
} as unknown as DocumentNode<DashboardsListQuery, DashboardsListQueryVariables>
...
export const DashboardsListQuerySchema: z.ZodType<DashboardsListQuery> = z.object({
  dashboards: z.array(
    z.object({
      id: z.string(),
      name: z.string(),
