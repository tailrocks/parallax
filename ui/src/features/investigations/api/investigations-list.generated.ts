...
export type InvestigationsListQueryVariables = Exact<{ [key: string]: never }>

export type InvestigationsListQuery = {
...
export const InvestigationsListDocument = {
  kind: "Document",
  definitions: [
    {
      kind: "OperationDefinition",
      operation: "query",
      name: { kind: "Name", value: "InvestigationsList" },
      selectionSet: {
        kind: "SelectionSet",
        selections: [
          {
            ...
            selectionSet: {
              ...
              selections: [
                ...
                { kind: "Field", name: { kind: "Name", value: "createdAtNanos" } },
              ],
            },
          },
        ],
...
} as unknown as DocumentNode<InvestigationsListQuery, InvestigationsListQueryVariables>
...
export const InvestigationsListQuerySchema: z.ZodType<InvestigationsListQuery> = z.object({
