...
export type InvestigationSaveMutationVariables = Exact<{
  name: string
  state: string
  id?: string | null | undefined
}>

export type InvestigationSaveMutation = {
...
export const InvestigationSaveDocument = {
  kind: "Document",
  definitions: [
    {
      kind: "OperationDefinition",
      operation: "mutation",
      name: { kind: "Name", value: "InvestigationSave" },
      variableDefinitions: [
        {
