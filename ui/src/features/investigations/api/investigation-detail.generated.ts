...
export type InvestigationDetailQueryVariables = Exact<{
  id: string
}>

export type InvestigationDetailQuery = {
...
export const InvestigationDetailDocument = {
  kind: "Document",
  definitions: [
    {
      kind: "OperationDefinition",
      operation: "query",
      name: { kind: "Name", value: "InvestigationDetail" },
      variableDefinitions: [
        {
...
} as unknown as DocumentNode<InvestigationDetailQuery, InvestigationDetailQueryVariables>
...
export const InvestigationDetailQuerySchema: z.ZodType<InvestigationDetailQuery> = z.object({
  investigation: z
    .object({
      id: z.string(),
      name: z.string(),
