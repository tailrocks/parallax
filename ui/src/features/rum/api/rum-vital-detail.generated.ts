...
export type RumVitalDetailQueryVariables = Exact<{
  name: string
  fromNanos: string
  toNanos: string
...
export type RumVitalDetailQuery = {
  readonly metricExemplars: ReadonlyArray<{
...
export const RumVitalDetailDocument = {
  kind: "Document",
  definitions: [
    {
      kind: "OperationDefinition",
      operation: "query",
      name: { kind: "Name", value: "RumVitalDetail" },
      variableDefinitions: [
        {
...
} as unknown as DocumentNode<RumVitalDetailQuery, RumVitalDetailQueryVariables>
...
export const RumVitalDetailQuerySchema: z.ZodType<RumVitalDetailQuery> = z.object({
  metricExemplars: z.array(
    z.object({
      tsNanos: z.string(),
      service: z.string(),
      name: z.string(),
