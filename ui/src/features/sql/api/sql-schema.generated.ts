...
export type SqlSchemaQueryVariables = Exact<{
  query: string
}>

export type SqlSchemaQuery = {
  readonly sql: {
...
export const SqlSchemaDocument = {
  kind: "Document",
  definitions: [
    {
      kind: "OperationDefinition",
      operation: "query",
      name: { kind: "Name", value: "SqlSchema" },
      variableDefinitions: [
        {
...
} as unknown as DocumentNode<SqlSchemaQuery, SqlSchemaQueryVariables>
...
export const SqlSchemaQuerySchema: z.ZodType<SqlSchemaQuery> = z.object({
  sql: z.object({
