...
export type SqlExecuteQueryVariables = Exact<{
  query: string
}>

export type SqlExecuteQuery = {
  readonly sql: {
...
export const SqlExecuteDocument = {
  kind: "Document",
  definitions: [
    {
      kind: "OperationDefinition",
      operation: "query",
      name: { kind: "Name", value: "SqlExecute" },
      variableDefinitions: [
        {
...
} as unknown as DocumentNode<SqlExecuteQuery, SqlExecuteQueryVariables>
...
export const SqlExecuteQuerySchema: z.ZodType<SqlExecuteQuery> = z.object({
  sql: z.object({
