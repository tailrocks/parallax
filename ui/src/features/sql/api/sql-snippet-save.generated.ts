...
export type SqlSnippetSaveMutationVariables = Exact<{
  name: string
  page: string
  state: string
}>

export type SqlSnippetSaveMutation = {
  readonly savedViewSave: {
    readonly id: string
...
export const SqlSnippetSaveDocument = {
  kind: "Document",
  definitions: [
    {
      kind: "OperationDefinition",
      operation: "mutation",
      name: { kind: "Name", value: "SqlSnippetSave" },
      variableDefinitions: [
        {
      ...
      selectionSet: {
        ...
        selections: [
          {
            kind: "Field",
            name: { kind: "Name", value: "savedViewSave" },
            arguments: [
              {
                kind: "Argument",
...
} as unknown as DocumentNode<SqlSnippetSaveMutation, SqlSnippetSaveMutationVariables>
...
export const SqlSnippetSaveMutationSchema: z.ZodType<SqlSnippetSaveMutation> = z.object({
  savedViewSave: z.object({
    id: z.string(),
    name: z.string(),
    page: z.string(),
    state: z.string(),
