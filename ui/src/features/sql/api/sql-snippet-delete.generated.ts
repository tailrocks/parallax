...
export type SqlSnippetDeleteMutationVariables = Exact<{
  id: string
}>

export type SqlSnippetDeleteMutation = { readonly savedViewDelete: boolean }

export const SqlSnippetDeleteDocument = {
  kind: "Document",
  definitions: [
    {
      kind: "OperationDefinition",
      operation: "mutation",
      name: { kind: "Name", value: "SqlSnippetDelete" },
      variableDefinitions: [
        {
      ...
      selectionSet: {
        ...
        selections: [
          {
            kind: "Field",
            name: { kind: "Name", value: "savedViewDelete" },
            arguments: [
              {
                kind: "Argument",
...
} as unknown as DocumentNode<SqlSnippetDeleteMutation, SqlSnippetDeleteMutationVariables>
...
export const SqlSnippetDeleteMutationSchema: z.ZodType<SqlSnippetDeleteMutation> = z.object({
  savedViewDelete: z.boolean(),
})
