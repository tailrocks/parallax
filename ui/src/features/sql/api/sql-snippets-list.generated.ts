...
export type SqlSnippetsListQueryVariables = Exact<{
  page?: string | null | undefined
}>

export type SqlSnippetsListQuery = {
...
export const SqlSnippetsListDocument = {
  kind: "Document",
  definitions: [
    {
      kind: "OperationDefinition",
      operation: "query",
      name: { kind: "Name", value: "SqlSnippetsList" },
      variableDefinitions: [
        {
      ...
      selectionSet: {
        ...
        selections: [
          {
            kind: "Field",
            name: { kind: "Name", value: "savedViews" },
            arguments: [
              {
                kind: "Argument",
...
} as unknown as DocumentNode<SqlSnippetsListQuery, SqlSnippetsListQueryVariables>
...
export const SqlSnippetsListQuerySchema: z.ZodType<SqlSnippetsListQuery> = z.object({
  savedViews: z.array(
    z.object({
      id: z.string(),
      name: z.string(),
