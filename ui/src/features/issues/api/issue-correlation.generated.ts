...
} as unknown as DocumentNode<IssueCorrelationQuery, IssueCorrelationQueryVariables>
...
export const IssueCorrelationQuerySchema: z.ZodType<IssueCorrelationQuery> = z.object({
  trace: z
    .object({
      spans: z.array(
        z.object({
