...
export type ServiceMapQueryVariables = Exact<{
  fromNanos: string
  toNanos: string
  maxTraces?: number | null | undefined
}>

export type ServiceMapQuery = {
  readonly serviceMap: {
...
export const ServiceMapDocument = {
  kind: "Document",
  definitions: [
    {
      kind: "OperationDefinition",
      operation: "query",
      name: { kind: "Name", value: "ServiceMap" },
      variableDefinitions: [
        {
...
} as unknown as DocumentNode<ServiceMapQuery, ServiceMapQueryVariables>
...
export const ServiceMapQuerySchema: z.ZodType<ServiceMapQuery> = z.object({
  serviceMap: z.object({
    nodes: z.array(
      z.object({
        name: z.string(),
