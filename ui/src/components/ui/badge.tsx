...
const badgeVariants = cva(
  "group/badge inline-flex w-fit shrink-0 items-center justify-center overflow-hidden font-medium whitespace-nowrap capitalize transition-all focus-visible:border-ring focus-visible:ring-[3px] focus-visible:ring-ring/50 aria-invalid:border-destructive aria-invalid:ring-destructive/20 dark:aria-invalid:ring-destructive/40 [&>svg]:pointer-events-none",
  {
    variants: {
      variant: {
        default:
        ...
        secondary:
          "bg-secondary text-secondary-foreground shadow-(--custom-shadow-secondary) [a]:hover:bg-secondary/80",
        destructive:
        ...
        outline:
          "text-foreground shadow-(--custom-shadow) [a]:hover:bg-muted [a]:hover:text-muted-foreground",
      },
      size: {
        md: "h-5 gap-[5px] rounded-full px-2 py-0.5 text-xs has-[>svg:first-child]:pl-1.5 has-[>svg:last-child]:pr-1.5 [&>svg]:size-3!",
        lg: "h-6 gap-1.5 rounded-full px-2.5 py-1 text-sm has-[>svg:first-child]:pl-2 has-[>svg:last-child]:pr-2 [&>svg]:size-3.5!",
      },
    },
    defaultVariants: {
      variant: "default",
