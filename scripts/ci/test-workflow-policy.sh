...
rg '^    needs: \[changes, actionlint, source-hygiene, security-hygiene, policy, fmt, docs-links, audit, check, clippy, test, ui, ui-formatter-platform, embed, native-macos, browser-contracts, closure-final, fuzz-bench\]$' "$workflows/ci.yml" >/dev/null || {
