...
rg '^    needs: \[changes, actionlint, source-hygiene, security-hygiene, policy, fmt, audit, check, clippy, test, ui, ui-formatter-platform, embed, native-macos\]$' "$workflows/ci.yml" >/dev/null || {
