...
Every executable Linux workflow uses one canonical YAML shape on all lanes:
...
Velnor fleet is unavailable. Native Darwin release builders are the documented
